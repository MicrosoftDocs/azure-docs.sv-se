...
| Parameter | Krävs | Typ | Description |
| --------- | -------- | ---- | ----------- |
| <*värde*> | Yes | Valfri | Värdet som ska konverteras till Boolean. |
|||||
...
| <*krävande*> | No | Integer | Ett positivt antal tecken som du vill ha i under strängen |
|||||

...
| omfång | Inga | Omfattnings egenskapen är endast tillgänglig för [resurs typer för tillägg](../management/extension-resource-types.md). Använd den när du anger ett omfång som skiljer sig från distributions omfånget. Se [inställnings omfång för tilläggs resurser i arm-mallar](scope-extension-resources.md). |

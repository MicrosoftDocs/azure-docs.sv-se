...
|JavaScript (Node.js)|[Använd JavaScript SDK i Node.js för att ange ACL: er i Azure Data Lake Storage Gen2](data-lake-storage-directory-file-acl-javascript.md)|

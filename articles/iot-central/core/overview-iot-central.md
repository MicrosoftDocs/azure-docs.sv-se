...
- En _enhetsutvecklare_ [skapar den kod som körs på en enhet eller en](concepts-telemetry-properties-commands.md) IoT Edge [som](concepts-iot-edge.md) är ansluten till ditt program.

## <a name="create-your-iot-central-application"></a>Skapa ditt IoT Central program

Du kan snabbt distribuera ett nytt IoT Central program och sedan anpassa det efter dina specifika krav. Börja med en allmän _programmall_ eller med någon av de branschfokuserade programmallarna [för Detaljhandel,](../retail/overview-iot-central-retail.md) [Energi,](../energy/overview-iot-central-energy.md) [Myndigheter](../government/overview-iot-central-government.md)eller [Hälsovård.](../healthcare/overview-iot-central-healthcare.md)
...
När du har skapat ditt program är det första steget att skapa en ansluta enheter. Varje enhet som är ansluten IoT Central använder en _enhetsmall_. En enhetsmall är skissen som definierar egenskaper och beteende för en typ av enhet, till exempel:
...
- Skapa en enhetsmodell med hjälp Visual Studio kod. Implementera enhetskoden från modellen. Importera enhetsmodellen manuellt till ditt IoT Central program och lägg sedan till eventuella molnegenskaper, anpassningar och instrumentpaneler som IoT Central programbehov.

Se [snabbstarten Lägg till en simulerad](quick-create-simulated-device.md) enhet för en genomgång av hur du skapar och ansluter din första enhet.

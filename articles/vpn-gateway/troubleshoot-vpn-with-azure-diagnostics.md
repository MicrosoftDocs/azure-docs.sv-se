...
Konfigurations ändringar granskas i **GatewayDiagnosticLog** -tabellen. Observera att det kan ta några minuter innan ändringarna du kör avspeglas i loggarna.
...
|***Namn** _ | _ *_Beskrivning_** |
|---        | ---               |
|**TimeGenerated** | tidsstämpeln för varje händelse, i UTC-timezone|
...
:::image type="content" source="./media/troubleshoot-vpn-with-azure-diagnostics/image-26-set-gateway.png" alt-text="Exempel på set Gateway-åtgärd.":::
...
:::image type="content" source="./media/troubleshoot-vpn-with-azure-diagnostics/image-16-tunnel-connected.png" alt-text="Exempel på tunnel ansluten händelse.":::
...
:::image type="content" source="./media/troubleshoot-vpn-with-azure-diagnostics/image-31-bgp-route.png" alt-text="BGP Route-exempel.":::
...
|---        | ---               |
|**TimeGenerated** | tidsstämpeln för varje händelse, i UTC-timezone|
| **RemoteIP** | IP-adressen för den lokala VPN-enheten. I verkliga scenarier är det bra att filtrera efter IP-adressen för den relevanta lokala enheten, men det finns fler än en |
...
|**Händelse** | innehåller ett diagnostiskt meddelande som är användbart för fel sökning. De börjar vanligt vis med ett nyckelord och refererar till åtgärder som utförs av Azure Gateway- **\[ sändningen \]** anger att en händelse som orsakas av ett IPSec-paket som har skickats av Azure Gateway **\[ \] mottog** en händelse i följd av att ett paket som tagits emot från lokal enhet **\[ lokalt \]** indikerar en åtgärd som har tagits emot lokalt av Azure-gatewayen |
...
Den senast tillgängliga tabellen för VPN-diagnostik är **P2SDiagnosticLog**. Detta spårar aktiviteten för plats-till-plats.
...
:::image type="content" source="./media/troubleshoot-vpn-with-azure-diagnostics/image-28-p2s-log-event.png" alt-text="Exempel på P2S-loggar.":::
...
:::image type="content" source="./media/troubleshoot-vpn-with-azure-diagnostics/image-29-eap.png" alt-text="Exempel på EAP-loggar.":::

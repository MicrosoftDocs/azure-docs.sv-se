...
Använd LUIS [batch File-syntax](./luis-how-to-batch-test.md#batch-syntax-template-for-intents-with-entities) för att definiera en grupp av tester i en JSON-formaterad fil. Exempel:

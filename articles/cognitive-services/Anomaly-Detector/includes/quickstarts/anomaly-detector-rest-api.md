...
En övergripande titt på begrepp för avvikelse detektor finns i [översikts](../../overview.md) artikeln.
...
## <a name="detect-anomalies-for-an-entire-series"></a>Identifiera avvikelser för en hel serie
...
- En giltig JSON-fil med Time Series-data för att testa avvikelser. Om du inte har en egen fil kan du skapa en sample.jspå en fil från [exemplet på begär ande texten](https://westus2.dev.cognitive.microsoft.com/docs/services/AnomalyDetector/operations/post-timeseries-entire-detect).
...
Mer information finns i REST- [referens för avvikelse identifiering](https://westus2.dev.cognitive.microsoft.com/docs/services/AnomalyDetector/operations/post-timeseries-entire-detect).

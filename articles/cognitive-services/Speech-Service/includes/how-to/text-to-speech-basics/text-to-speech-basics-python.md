...
> [!NOTE]
> Om du vill ändra rösten utan att använda SSML kan du ställa in egenskapen på med `SpeechConfig` hjälp av `SpeechConfig.speech_synthesis_voice_name = "en-US-AriaNeural"`

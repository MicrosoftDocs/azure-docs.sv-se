...
:::row:::
    :::column span="3":::
        Xamarin. Android exponerar hela Android SDK för .NET-utvecklare. Bygg helt inbyggda Android-appar med C# eller F # i Visual Studio. Mer information finns i <a href="https://docs.microsoft.com/xamarin/android/" target="_blank">Xamarin. Android </a>
    :::column-end:::
    :::column:::
        <br>
        <div class="icon is-large">

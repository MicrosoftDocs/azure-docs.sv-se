...
:::row:::
    :::column span="3":::
        Xamarin. Mac visar hela macOS SDK för .NET-utvecklare för att bygga inbyggda Mac-program med C#. Mer information finns i <a href="/xamarin/mac/" target="_blank">Xamarin. Mac </a>.
    :::column-end:::
    :::column:::
        <br>
        <div class="icon is-large">

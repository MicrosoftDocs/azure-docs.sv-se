...
### <a name="increased-file-size-limit"></a>Ökad fil storleks gräns
...
### <a name="new-data-structure"></a>Ny data struktur
...
### <a name="new-detectable-face-attribute"></a>Nytt identifierbart ansikts attribut
...
* Det gick inte att identifiera FACET igen med den rektangel som returnerades från [ansikts igenkänning](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395236) som `targetFace` i [FaceList – Lägg till ansikte](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395250) och [PersonGroup person – Lägg till ansikte](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f3039523b).
* Den identifierade ansikts storleken är inställd på att säkerställa att den är strikt mellan 36x36 och 4096x4096 bild punkter.

## <a name="november-2016"></a>November 2016
### <a name="new-subscription-tier"></a>Ny prenumerations nivå
...
### <a name="api-messages"></a>API-meddelanden
* Ändrade fel meddelandet för mer än ett ansikte i `targetFace` från finns det fler än ett ansikte i bilden till det finns fler än ett ansikte i bilden i [FaceList – Lägg till ansikte](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395250) och [PersonGroup person – Lägg till ansikte](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f3039523b).

---
title: Dokument översättning hämta dokument format metod
titleSuffix: Azure Cognitive Services
description: Metoden hämta dokument format returnerar en lista över dokument format som stöds.
...
ms.locfileid: "105613158"
---
# <a name="document-translation-get-document-formats"></a>Dokument översättning: Hämta dokument format

Metoden hämta dokument format returnerar en lista med dokument format som stöds av dokument översättnings tjänsten. Listan innehåller common File Extension och Content-Type om du använder överförings-API: et.
...
|--- |--- |--- |
|värde|FileFormat []|FileFormat [] innehåller information som anges nedan.|
|värde. format|sträng []|Innehålls typer som stöds för det här formatet.|
|Value. fileExtensions|sträng []|Fil namns tillägg som stöds för det här formatet.|
|Value. contentType|sträng []|Namn på formatet.|
|värde. versioner|Sträng []|Version som stöds.|

### <a name="error-response"></a>Fel svar

|Namn|Typ|Beskrivning|
|--- |--- |--- |
 |kod|sträng|Uppräkningar som innehåller fel koder på hög nivå. Möjliga värden:<ul><li>InternalServerError</li><li>InvalidArgument</li><li>InvalidRequest</li><li>RequestRateTooHigh</li><li>ResourceNotFound</li><li>ServiceUnavailable</li><li>Behörighet saknas</li></ul>|

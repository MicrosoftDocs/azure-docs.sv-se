...
## <a name="what-is-the-maximum-size-and-number-of-requests-i-can-make-to-the-api"></a>Vad är den maximala storleken och antalet begär Anden som jag kan göra till API: et?

Se artikeln [data begränsningar](concepts/data-limits.md) för information om storlek och antal begär Anden som du kan skicka per minut och sekund.

...
Du kan också använda analys åtgärden för att identifiera PII, identifiera länkade entiteter och extrahering av nyckel fraser. Se [analys exemplet](https://github.com/Azure/azure-sdk-for-net/blob/master/sdk/textanalytics/Azure.AI.TextAnalytics/samples/Sample_AnalyzeOperation.md) på GitHub.

...
ms.locfileid: "97505824"
---
# <a name="version-31-preview"></a>[Version 3,1 Preview](#tab/version-3-1)

[v 3.1 referens dokumentation](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-3/)
...
> [!NOTE]
> Exemplet nedan innehåller en begäran om utgångs punkt i Attitydanalys med hjälp av `opinionMining=true` parametern, som ger detaljerad information om de åsikter som rör aspekter (till exempel attributen för produkter eller tjänster) i text.

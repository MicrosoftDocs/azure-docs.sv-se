...
Två skript definieras i **fileUris**  -  -*installserver.sh* och *workserver.py*. Filerna laddas ned från GitHub och sedan  körs commandToExecute `bash installserver.sh` för att installera och konfigurera appen.

...
Azure Disk Encryption använder Azure Key Vault för att styra och hantera diskkrypteringsnycklar och hemligheter.  Mer information om nyckelvalv finns i Kom [igång med Azure Key Vault](../key-vault/general/overview.md) och Skydda ditt [nyckelvalv.](../key-vault/general/secure-your-key-vault.md)

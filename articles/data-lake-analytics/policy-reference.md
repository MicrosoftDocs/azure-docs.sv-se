---
title: Inbyggda principdefinitioner för Azure Data Lake Analytics
description: Visar Azure Policy inbyggda principdefinitioner för Azure Data Lake Analytics. Dessa inbyggda principdefinitioner tillhandahåller vanliga metoder för att hantera dina Azure-resurser.
ms.date: 04/14/2021
ms.topic: reference
author: JasonWHowell
ms.author: jasonh
...
Den här sidan är ett index [Azure Policy](../governance/policy/overview.md) inbyggda principdefinitioner för Azure Data Lake Analytics. Ytterligare Azure Policy inbyggda funktioner för andra tjänster finns i [Azure Policy inbyggda definitionerna](../governance/policy/samples/built-in-policies.md).

...
Mer information om hur du skaffar en Azure AD-token för ditt program finns i [Access Analytics-data med Store-tjänster](/windows/uwp/monetize/access-analytics-data-using-windows-store-services#step-2-obtain-an-azure-ad-access-token).
...
- Du kan prova API: erna via [URL: en för Swagger-API](https://swagger.io/docs/specification/api-host-and-base-path/)

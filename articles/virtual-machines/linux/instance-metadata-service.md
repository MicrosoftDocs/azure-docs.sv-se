...
IMDS-slutpunkter stöder HTTP-frågeparametrar. Till exempel: 
...
| `zone` | [Tillgänglighets zon](../../availability-zones/az-overview.md) för den virtuella datorn | 2017-12-01
...
#### <a name="sample-5-retrieve-network-information"></a>Exempel 5: Hämta nätverks information
...
#### <a name="sample-6-retrieve-public-ip-address"></a>Exempel 6: Hämta offentlig IP-adress
...
1. Dumpa din lokala routningstabell och leta efter IMDS-posten. Till exempel:         
    ```console
      > route print
      IPv4 Route Table
      ===========================================================================
      ...
      ... (continues) ...
    ```
1. Kontrol lera att det finns en väg för `169.254.169.254` och anteckna motsvarande nätverks gränssnitt (exempel `172.16.69.7` ).

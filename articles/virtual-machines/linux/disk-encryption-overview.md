...
| Redhat | RHEL 7 – LVM | 7-LVM | RedHat: RHEL: 7-LVM: 7.9.2020111202 | Operativ system och data disk (se OBS! nedan) |
| Redhat | RHEL 7,9 | 7_9 | RedHat: RHEL: 7_9: senaste | Operativ system och data disk (se OBS! nedan) |
...
| OpenLogic | CentOS 7 – LVM | 7-LVM | OpenLogic: CentOS-LVM: 7-LVM: 7.9.2021020400 | Operativ system och data disk |
| OpenLogic | CentOS 7,9 | 7_9 | OpenLogic: CentOS: 7_9: senaste | Operativ system och data disk |
| OpenLogic | CentOS 7,8 | 7_8 | OpenLogic: CentOS: 7_8: senaste | Operativ system och data disk |

...
Du kan förlita dig på plattformhanterade nycklar för kryptering av din hanterade disk, eller så kan du hantera kryptering med dina egna nycklar. Om du väljer att hantera kryptering med dina  egna nycklar kan du ange en kundhanterad nyckel som ska användas för kryptering och dekryptering av alla data i hanterade diskar. 
...
Virtuella diskar i Azure kan [krypteras](linux/disk-encryption-overview.md) för förbättrad säkerhet och efterlevnad för virtuella [Windows-](windows/disk-encryption-overview.md) och Linux-datorer. Virtuella diskar på virtuella Windows-datorer krypteras i vila med hjälp av BitLocker. Virtuella diskar på virtuella Linux-datorer krypteras i vila med dm-crypt. 

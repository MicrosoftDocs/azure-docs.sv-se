...
Förutom att du är bekant med att distribuera virtuella datorer i Azure, rekommenderar vi att du läser [Hantera tillgängligheten för virtuella Windows-datorer i Azure](../../availability.md)innan du definierar din tillgänglighets arkitektur i Azure.

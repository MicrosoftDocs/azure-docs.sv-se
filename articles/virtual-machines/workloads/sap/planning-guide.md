...
Mer information finns i [tillgänglighet för virtuella Windows-datorer i Azure](../../availability.md) och [tillgänglighet för virtuella Linux-datorer i Azure](../../availability.md).

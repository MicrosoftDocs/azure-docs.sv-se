...
#### <a name="prerequisites-for-adding-netweaver-provider"></a>Krav för att lägga till NetWeaver-providern
...
7. Gå tillbaka och välj Profil->Spara
8. Starta om systemet för att parametern ska börja gälla

>[!Tip]
> Använd en Access Control (ACL) för att filtrera åtkomsten till en serverport. Se [sap-anteckningen](https://launchpad.support.sap.com/#/notes/1495075)
...
1. Välj fliken **Provider** för att lägga till de providers som du vill konfigurera. Du kan lägga till flera providers en efter en eller lägga till dem när du har distribuerat övervakningsresursen. 

   :::image type="content" source="./media/azure-monitor-sap/azure-monitor-quickstart-3.png" alt-text="Visar fliken provider för att lägga till ytterligare leverantörer i Azure Monitor för SAP-lösningar." lightbox="./media/azure-monitor-sap/azure-monitor-quickstart-3.png":::
...
5. Ange det SQL-portnummer som är associerat med HANA-databasen. Portnumret ska ha formatet **[3]**  +  **[instans#]**  +  **[13]**. Till exempel 30013. 

6. Ange det databasnamn som du vill använda. Se till att databasanvändaren har **tilldelats** **läsroller för** övervakning och katalog. 
...
4. När du är klar väljer du **Lägg till provider.** Fortsätt att lägga till fler leverantörer efter behov eller välj **Granska + skapa** för att slutföra distributionen.
     ...
     :::image type="content" source="./media/azure-monitor-sap/azure-monitor-quickstart-6.png" alt-text="Bild som visar information om att lägga till Microsoft SQL Server providern." lightbox="./media/azure-monitor-sap/azure-monitor-quickstart-6.png":::

### <a name="high-availability-cluster-pacemaker-provider"></a>Provider för kluster med hög tillgänglighet (Pacemaker)

1. Välj **Kluster med hög tillgänglighet (Pacemaker)** i listrutan. 

   > [!IMPORTANT]
   > Om du vill konfigurera providern för kluster med hög tillgänglighet (Pacemaker) ha_cluster_provider installeras i varje nod. Mer information finns i [Ha-klusterexporterare](https://github.com/ClusterLabs/ha_cluster_exporter#installation)
...
4. När du är klar väljer du **Lägg till provider.** Fortsätt att lägga till fler leverantörer efter behov eller välj **Granska + skapa** för att slutföra distributionen.
   ...
   :::image type="content" source="./media/azure-monitor-sap/azure-monitor-quickstart-5.png" alt-text="Bild som visar alternativ relaterade till HA-klustrets pacemakerprovider." lightbox="./media/azure-monitor-sap/azure-monitor-quickstart-5.png":::
...
1. Välj OS (Linux) i listrutan 
   ...
   >[!IMPORTANT]
   > Om du vill konfigurera OS-providern (Linux) måste du se till att den senaste versionen Node_Exporter är installerad på varje värd (BareMetal eller VM) som du vill övervaka. Använd den här [länken](https://prometheus.io/download/#node_exporter) för att hitta den senaste versionen. Mer information finns i [Node_Exporter](https://github.com/prometheus/node_exporter)
...
3. Ange Node Exporter-slutpunkten i form av http://IP:9100/metrics .
   ...
   >Om du använder firewall-cmd: firewall-cmd --permanent --add-port=9100/tcp firewall-cmd --reload Om du använder ufw: ufw tillåt 9100/tcp ufw reload
    ...
    >[!Tip]
    > Om Linux-värden är en virtuell Azure-dator måste du se till att alla tillämpliga NSG:er tillåter inkommande trafik på port 9100 från "VirtualNetwork" som källa.

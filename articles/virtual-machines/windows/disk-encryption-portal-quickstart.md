...
1. På skärmen **Välj nyckel från Azure Key Vault** väljer du **Skapa ny**.
    ...
    :::image type="content" source="../media/disk-encryption/portal-qs-keyvault-create.png" alt-text="Skärm bild som visar alternativet Skapa nytt.":::

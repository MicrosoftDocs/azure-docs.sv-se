---
title: Azures säkerhets bas linje för Virtuella Windows-datorer
...
ms.locfileid: "107285094"
---
# <a name="azure-security-baseline-for-windows-virtual-machines"></a>Azures säkerhets bas linje för Virtuella Windows-datorer

Den här säkerhets bas linjen använder vägledning från [Azures säkerhets benchmark-version 1,0](../../security/benchmarks/overview-v1.md) till virtuella Windows-datorer. Azure Security Benchmark ger rekommendationer om hur du kan skydda dina molnlösningar i Azure. Innehållet grupperas efter de **säkerhets kontroller** som definieras av Azures säkerhets benchmark och relaterade rikt linjer som gäller för virtuella Windows-datorer.

> [!NOTE]
> **Kontroller** som inte är tillämpliga på virtuella Windows-datorer, eller för vilka ansvaret är Microsofts, har uteslutits. Om du vill se hur Virtuella Windows-datorer helt mappar till Azures säkerhets mätning, se den **[fullständiga virtuella Windows-datorer mappnings filen för säkerhets bas linjen](https://github.com/MicrosoftDocs/SecurityBenchmarks/blob/master/Azure%20Offer%20Security%20Baselines/1.1/windows-virtual-machines-security-baseline-v1.1.xlsx)**.
...
- [Samla in plattforms loggar och mått med Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/essentials/activity-log#view-the-activity-log)
...
**Vägledning**: Virtuella Windows-datorer och Azure Active Directory (Azure AD) har inte begreppet standard lösen ord. Kund ansvarig för program från tredje part och Marketplace-tjänster som kan använda standard lösen ord.
...
### <a name="36-use-secure-azure-managed-workstations-for-administrative-tasks"></a>3,6: Använd säkra, Azure Managed-arbetsstationer för administrativa uppgifter 
...
**Vägledning**: Konfigurera diagnostikinställningar för Azure Active Directory (Azure AD) för att skicka gransknings loggar och inloggnings loggar till en Log Analytics arbets yta. Du kan också använda Azure Monitor för att granska loggar och köra frågor om loggdata från virtuella Azure-datorer.
...
- [Kryptering på Server sidan av Azure-hanterade diskar](/azure/virtual-machines/windows/disk-encryption)

- [Azure Disk Encryption för virtuella Windows-datorer](/azure/virtual-machines/windows/disk-encryption-overview)
...
- [Ladda upp en anpassad virtuell hård disk till Azure](upload-generalized-managed.md)

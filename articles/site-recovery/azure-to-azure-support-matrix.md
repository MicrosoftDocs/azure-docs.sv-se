...
Den här artikeln sammanfattar support och krav för [haveriberedskap](site-recovery-overview.md) för virtuella Azure-datorer från en Azure-region till en annan med hjälp av Azure Site Recovery tjänsten.
...
Du kan replikera och återställa virtuella datorer mellan två regioner inom samma geografiska kluster. Geografiska kluster definieras med datafördröjning och självbestämmande i åtanke.
...
Europa | Storbritannien, västra, Storbritannien, södra, Europa, norra, Europa, västra, Sydafrika, västra, Sydafrika, norra, Schweiz, östra, Frankrike, centrala, Schweiz, norra, Tyskland, västra centrala
...
JIO | JIO Indien, västra
Australien    | Australien, östra, Australien, sydöstra, Australien, centrala, Australien, centrala 2
Azure Government    | US GOV, Virginia, USA GOV, Iowa, US GOV, Arizona, US GOV, Texas, USA DOD, östra, USA DOD, centrala
Tyskland    | Tyskland, centrala, Tyskland, nordöstra
Kina | Kina, östra, Kina, norra, Kina, norra 2, Kina, östra2
Brasilien | Brasilien, södra
Begränsade regioner som är reserverade för haveriberedskap i landet |Schweiz, västra är reserverat för Schweiz, norra; Frankrike, södra är reserverat för Frankrike, centrala; Förenade Arabemiraten, centrala är begränsat för kunder i Förenade Arabemiraten, norra; Tyskland, västra för kunder i Brasilien, östra; JIO Indien, centrala för JIO-kunder i Indien, västra, Brasilien, sydöstra för Brasilien, södra

>[!NOTE]
>
> - För **Brasilien, södra** kan du replikera och redundans för dessa regioner: Brasilien, sydöstra, USA, södra centrala, USA, västra centrala, USA, östra, USA, östra 2, USA, västra, USA, västra 2 och USA, norra centrala.
> - Brasilien, södra kan bara användas som en källregion som virtuella datorer kan replikeras från med hjälp av Site Recovery. Den kan inte fungera som en målregion. Detta beror på problem med svarstider på grund av geografiska avstånd. Observera att om du redundansar från Brasilien, södra som en källregion till ett mål, stöds återställning efter fel till Brasilien, södra från målregionen. Brasilien, sydöstra kan bara användas som en målregion.
...
Azure Storage brandväggar för virtuella nätverk  | Stöds | Om du använder ett brandväggsaktiverad cachelagringskonto eller mållagringskonto ser du till att ["Tillåt betrodda Microsoft-tjänster"](../storage/common/storage-network-security.md#exceptions).<br></br>Kontrollera också att du tillåter åtkomst till minst ett undernät för det virtuella källnätverket.

Tabellen nedan visar gränserna för antalet diskar som kan replikeras till ett enda lagringskonto.

**Typ av lagringskonto**    |    **Omsättning = 4 MBps per disk**    |    **Omsättning = 8 MBps per disk**
---    |    ---    |    ---
V1-lagringskonto    |    300 diskar    |    150 diskar
V2-lagringskonto    |    750 diskar    |    375 diskar

När den genomsnittliga omsättningen på diskarna ökar minskar antalet diskar som ett lagringskonto har stöd för. Tabellen ovan kan användas som vägledning för att fatta beslut om antalet lagringskonton som behöver etableras.

Observera att ovanstående gränser är specifika för Azure för Azure och zon-till-zon för DR-scenarier. 

## <a name="replicated-machine-operating-systems"></a>Replikerade operativsystem för datorer

Site Recovery stöder replikering av virtuella Azure-datorer som kör operativsystemen som anges i det här avsnittet. Observera att om en dator som redan replikeras senare uppgraderas (eller nedgraderas) till en annan större kernel, måste du inaktivera replikering och återaktivera replikering efter uppgraderingen.
...
Debian 7 | Innehåller stöd för alla 7. *x* versioner [av kernelversioner som stöds](#supported-debian-kernel-versions-for-azure-virtual-machines)
Debian 8 | Innehåller stöd för alla 8. *x* versioner [av kernelversioner som stöds](#supported-debian-kernel-versions-for-azure-virtual-machines)
...
|||
20.04 LTS |[9.41](https://support.microsoft.com/en-us/topic/update-rollup-54-for-azure-site-recovery-50873c7c-272c-4a7a-b9bb-8cd59c230533)| 5.4.0-26-generic till 5.4.0-65 </br> -generic 5.4.0-1010-azure to 5.4.0-1039-azure </br> 5.8.0-29-generic till 5.8.0-43-generic </br> 5.4.0-66-generic, 5.4.0-67-generic, 5.4.0-70-generic, 5.8.0-44-generic, 5.8.0-45-generic, 5.8.0-48-generic, 5.4.0-1040-azure, 5.4.0-1041-azure, 5.4.0-1043-azure till 9.41 hot fix**|
20.04 LTS |[9.40](https://support.microsoft.com/en-us/topic/update-rollup-53-for-azure-site-recovery-060268ef-5835-bb49-7cbc-e8c1e6c6e12a)| 5.4.0-26-generic till 5.4.0-59 </br> -generic 5.4.0-1010-azure to 5.4.0-1035-azure </br> 5.8.0-29-generic till 5.8.0-34-generic </br> 5.4.0-1036-azure, 5.4.0-60-generic, 5.4.0-62-generic, 5.8.0-36-generic, 5.8.0-38-generic, 5.4.0-1039-azure, 5.4.0-64-generic, 5.4.0-65-generic, 5.8.0-40-generic, 5.8.0-41-generic through 9.40 hot fix patch**|
20.04 LTS |[9.39](https://support.microsoft.com/help/4597409/) | 5.4.0-26-generic till 5.4.0-53 </br> -generic 5.4.0-1010-azure till 5.4.0-1031-azure </br> 5.4.0-54-generic, 5.8.0-29-generic, 5.4.0-1032-azure, 5.4.0-56-generic, 5.8.0-31-generic, 5.8.0-33-generic, 5.4.0-58-generic, 5.4.0-1034-azure through 9.39 hot fix patch**
20.04 LTS |[9.39](https://support.microsoft.com/help/4597409/) | 5.4.0-26-generic till 5.4.0-53 </br> -generic 5.4.0-1010-azure till 5.4.0-1031-azure </br> 5.4.0-54-generic, 5.8.0-29-generic, 5.4.0-1032-azure, 5.4.0-56-generic, 5.8.0-31-generic, 5.8.0-33-generic, 5.4.0-58-generic, 5.4.0-1034-azure through 9.39 hot fix patch**
20.04 LTS |[9,38](https://support.microsoft.com/help/4590304/) | 5.4.0-26-generic till 5.4.0-48 </br> -generic 5.4.0-1010-azure till 5.4.0-1026-azure </br> 5.4.0-51-generic, 5.4.0-52-generic, 5.8.0-23-generic, 5.8.0-25-generic, 5.4.0-1031-azure through 9.38 hot fix patch**
20.04 LTS |[9.37](https://support.microsoft.com/help/4582666/) | 5.4.0-26-generic till 5.4.0-45 </br> -generic 5.4.0-1010-azure till 5.4.0-1023-azure </br> 5.4.0-47-generic, 5.4.0-48-generic, 5.4.0-1025-azure, 5.4.0-1026-azure till 9.37 hot fix patch**
...
|||
Debian 9.1 | [9.41](https://support.microsoft.com/en-us/topic/update-rollup-54-for-azure-site-recovery-50873c7c-272c-4a7a-b9bb-8cd59c230533) | 4.9.0-1-amd64 till 4.9.0-14-amd64 </br> 4.19.0-0.bpo.1-amd64 till 4.19.0-0.bpo.14-amd64 </br> 4.19.0-0.bpo.1-cloud-amd64 till 4.19.0-0.bpo.14-cloud-amd64 </br> 4.9.0-15-amd64, 4.19.0-0.bpo.16-amd64, 4.19.0-0.bpo.16-cloud-amd64 till 9.41 snabbkorrigering**
...
Azure-galleriavbildningar – Publicerat från tredje part | Stöds | Stöds om den virtuella datorn körs på ett operativsystem som stöds.
Anpassade avbildningar – Publicerat från tredje part | Stöds | Stöds om den virtuella datorn körs på ett operativsystem som stöds.
...
Azure RBAC-principer | Stöds inte | Azure-principer för rollbaserad åtkomstkontroll (Azure RBAC) på virtuella datorer replikeras inte till den virtuella redundansdatorn i målregionen.
Tillägg | Stöds inte | Tillägg replikeras inte till den virtuella redundansdatorn i målregionen. Det måste installeras manuellt efter redundans.
Närhetsplaceringsgrupper | Stöds | Virtuella datorer som finns i en närhetsplaceringsgrupp kan skyddas med hjälp Site Recovery.
Taggar  | Stöds | Användargenererade taggar som tillämpas på virtuella källdatorer förs över till virtuella måldatorer efter redundanstest eller redundans. Taggar på de virtuella datorer replikeras en gång var 24:e timme så länge som de virtuella datorer finns i målregionen.
...
**Åtgärd** | **Information**
-- | ---
Ändra storlek på disk på replikerad virtuell dator | Stöds på den virtuella källdatorn före redundans. Du behöver inte inaktivera/återaktivera replikering.<br/><br/> Om du ändrar den virtuella källdatorn efter redundansväxlingen avbildas inte ändringarna.<br/><br/> Om du ändrar diskstorleken på den virtuella Azure-datorn efter en redundansväxling avbildas inte ändringar av Site Recovery och återställning efter fel sker till den ursprungliga VM-storleken.
Lägga till en disk till en replikerad virtuell dator | Stöds
Offlineändringar av skyddade diskar | Att koppla från diskar och göra offlineändringar av dem kräver att en fullständig omsynkronisering utlöses.
...
- Det är viktigt att observera vm-diskens gränser och mål för [hanterade diskar för](../virtual-machines/disks-scalability-targets.md) att undvika prestandaproblem.
...
--- | --- | ---
Maximal storlek för OS-disk | 2 048 GB | [Läs mer](../virtual-machines/managed-disks-overview.md) om VM-diskar.
...
Ta bort disk med snabb borttagning    | Stöds inte | Om du tar bort datadisken på den virtuella datorn måste du inaktivera replikering och aktivera replikering igen för den virtuella datorn.
...
Lagringsutrymmen direkt  | Stöds för kraschen konsekventa återställningspunkter. Program konsekventa återställningspunkter stöds inte. |
Skal ut filserver  | Stöds för krasch konsekventa återställningspunkter. Program konsekventa återställningspunkter stöds inte. |
...
V2-lagringskonton för generell användning (både nivån Hot och Cool) | Stöds | Transaktionskostnaderna ökar avsevärt jämfört med V1-lagringskonton för generell användning
...
Offentlig IP-adress | Stöds | Associera en befintlig offentlig IP-adress med nätverkskortet. Du kan också skapa en offentlig IP-adress och koppla den till nätverkskortet med hjälp Azure Automation ett skript i en återställningsplan.
NSG på nätverkskort | Stöds | Associera NSG med nätverkskortet med hjälp av Azure Automation skript i en återställningsplan.
NSG på undernät | Stöds | Associera NSG med undernätet med hjälp av ett Azure Automation skript i en återställningsplan.
Reserverad (statisk) IP-adress | Stöds | Om nätverkskortet på den virtuella källdatorn har en statisk IP-adress och målundernätet har samma tillgängliga IP-adress, tilldelas det till den virtuella datorn som inte är tillgänglig.<br/><br/> Om målundernätet inte har samma TILLGÄNGLIGA IP-adress reserveras en av de tillgängliga IP-adresserna i undernätet för den virtuella datorn.<br/><br/> Du kan också ange en fast IP-adress och undernät i **Replikerade objekt**  >  **Inställningar För**  >  **beräknings- och**  >  **nätverksnätverksgränssnitt.**
Dynamisk IP-adress | Stöds | Om nätverkskortet på källan har dynamisk IP-adressering är nätverkskortet på den virtuella datorn som är överlyckad också dynamiskt som standard.<br/><br/> Du kan ändra detta till en fast IP-adress om det behövs.
Flera IP-adresser | Stöds inte | När du redundans redundansar en virtuell dator som har ett nätverkskort med flera IP-adresser behålls endast den primära IP-adressen för nätverkskortet i källregionen. Om du vill tilldela flera IP-adresser [](recovery-plan-overview.md) kan du lägga till virtuella datorer i en återställningsplan och bifoga ett skript för att tilldela ytterligare IP-adresser till planen, eller så kan du göra ändringen manuellt eller med ett skript efter en redundansväxling.
...
Autentiserad proxy | Stöds inte | Om den virtuella datorn använder en autentiserad proxy för utgående anslutning kan den inte replikeras med Azure Site Recovery.
VPN-plats-till-plats-anslutning till lokal plats<br/><br/>(med eller utan ExpressRoute)| Stöds | Se till att UDR:erna och NSG:erna är konfigurerade på ett sådant sätt Site Recovery att trafiken inte dirigeras till den lokala platsen. [Läs mer](./azure-to-azure-about-networking.md)
VNET-till-VNET-anslutning    | Stöds | [Läs mer](./azure-to-azure-about-networking.md)
Tjänstslutpunkter för virtuellt nätverk | Stöds | Om du begränsar åtkomsten till lagringskonton i det virtuella nätverket ser du till att Microsoft-tjänster betrodda nätverk tillåts åtkomst till lagringskontot.
...
Privat länkåtkomst till Site Recovery tjänst | Stöds | [Läs mer](azure-to-azure-how-to-enable-replication-private-endpoints.md)

...
SUSE Linux Enterprise Server 15 och 15 SP1 | [9,36](https://support.microsoft.com/help/4578241/), [9,37](https://support.microsoft.com/help/4582666/)  | Som standard stöds alla [aktier i lager SUSE 15, SP1, SP2 kernels](https://www.suse.com/support/kb/doc/?id=000019587) .</br></br> 4.12.14 – 5.5 – Azure till 4.12.14 – 5.47 – Azure </br></br> 4.12.14 – 8.5 – Azure till 4.12.14 – 8.38 – Azure
...
> [!NOTE]
> Alla ändringar av disk identiteten stöds inte. Om disk partitionering exempelvis har ändrats från GPT till MBR eller vice versa, ändrar detta disk identiteten. I ett sådant scenario avbryts replikeringen och en ny installation krävs. För Linux-datorer stöds inte ändring av enhets namn eftersom det påverkar disk identiteten.

...
I den här artikeln har du lärt dig hur du binder ditt Azure våren Cloud-program till en Azure Cosmos DB-databas. Mer information om hur du kopplar tjänster till ditt program finns i [binda till en Azure-cache för Redis-cache](spring-cloud-howto-bind-redis.md).
...
I den här artikeln har du lärt dig hur du binder ditt Azure våren Cloud-program till Azure cache för Redis. Mer information om att binda tjänster till ditt program finns i [binda till en Azure Database for MySQL instans](spring-cloud-howto-bind-mysql.md).

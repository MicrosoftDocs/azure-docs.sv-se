...
> [!TIP]
> Om du använder ett privat lager för konfigurations servern, se vår [självstudie om hur du konfigurerar autentisering](./spring-cloud-howto-config-server.md).

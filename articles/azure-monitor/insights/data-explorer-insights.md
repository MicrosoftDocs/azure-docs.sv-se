---
title: Övervaka Azure Datautforskaren-kluster med Azure Monitor för Azure Datautforskaren (för hands version) | Microsoft Docs
...
ms.locfileid: "97901795"
---
# <a name="monitoring-your-azure-data-explorer-cluster-with-azure-monitor-for-azure-data-explorer-preview"></a>Övervaka ditt Azure Datautforskaren-kluster med Azure Monitor för Azure Datautforskaren (för hands version)
...
![Skärm bild av översikts upplevelse med flera grafer](./media/data-explorer-insights/insights-hub.png)
...
![Skärm bild av fliken fråga prestanda](./media/data-explorer-insights/query-performance.png)
...
[![Skärm bild av fliken inmatnings prestanda](./media/data-explorer-insights/ingestion-performance.png)](./media/data-explorer-insights/ingestion-performance.png#lightbox)
...
![Skärm bild av blå knapp som visar texten "Aktivera loggar för övervakning"](./media/data-explorer-insights/enable-logs.png)
...
[![Skärm bild av vy från en Azure Datautforskaren Cluster-resurs](./media/data-explorer-insights/overview.png)](./media/data-explorer-insights/overview.png#lightbox)
...
[![Skärm bild av vyn med problem](./media/data-explorer-insights/key-metrics.png)](./media/data-explorer-insights/key-metrics.png#lightbox)
...
[![Skärm bild av vyn vyer med ring diagram med högsta användning av kommando-och antal frågor, främsta huvud konton med kommando-och antal frågor och främsta kommandon efter kommando typer](./media/data-explorer-insights/usage.png)](./media/data-explorer-insights/usage.png#lightbox)

[![Skärm bild av vyn vyer med linje diagram av antal frågor per program, totalt minne efter program och total CPU per program](./media/data-explorer-insights/usage-2.png)](./media/data-explorer-insights/usage-2.png#lightbox)
...
[![Skärm bild av cache-information](./media/data-explorer-insights/cache-tab.png)](./media/data-explorer-insights/cache-tab.png#lightbox)
...
![Skärm bild av PIN-ikonen vald](./media/data-explorer-insights/pin.png)
...
![Skärm bild av knappen anpassa](./media/data-explorer-insights/customize.png)
...
![Skärm bild av arbets bokens Galleri](./media/data-explorer-insights/gallery.png)

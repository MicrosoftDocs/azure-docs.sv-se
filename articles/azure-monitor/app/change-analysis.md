...
För närvarande stöds alla textbaserade filer under plats roten **wwwroot** med följande tillägg:
- *. config
- *. XML
- *. JSON
- *. Gem
...
## <a name="enable-change-analysis-at-scale-for-web-app-in-guest-file-and-environment-variable-changes"></a>Aktivera ändrings analys i skala för webbappens ändringar i gäst filen och miljö variabeln

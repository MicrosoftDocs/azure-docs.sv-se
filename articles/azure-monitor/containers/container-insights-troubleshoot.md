...
Poddar i agenten Azure Monitor for containers använder cAdvisor-slutpunkten på nodagenten till att samla in prestandamått. Kontrol lera att den behållar agenten på noden är konfigurerad att tillåtas att `cAdvisor port: 10255` öppnas på alla noder i klustret för att samla in prestanda mått.

...
Arbets böcker kan vara komplexa, så en typisk strategi är att skapa arbets boken i Azure Portal och sedan skapa en Resource Manager-mall. Se information om den här metoden i [Azure Resource Manager mall för distribution av arbets böcker](../visualize/workbooks-automate.md).
...
* [Läs mer om åtgärds grupper](../visualize/workbooks-overview.md).

...
![Cherwell-anslutning](media/itsmc-connections-cherwell/itsm-connections-cherwell-latest.png)
...
3. Välj **skapa en ny klients** klient  >  **hemlighet**.
    ...
    ![Användar-ID för Cherwell](media/itsmc-connections-cherwell/itsmc-cherwell-client-id.png)

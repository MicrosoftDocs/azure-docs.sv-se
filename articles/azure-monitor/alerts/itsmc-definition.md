...
ms.locfileid: "103601074"
---
# <a name="connect-azure-to-itsm-tools-by-using-it-service-management-solution"></a>Ansluta Azure till ITSM-verktyg med IT Service Management-lösningen
...
Vissa typer av arbets objekt kan använda mallar som du definierar i ITSM-verktyget. Med hjälp av mallar kan du definiera fält som fylls i automatiskt enligt fasta värden för en åtgärds grupp. Du kan definiera vilken mall du vill använda som en del av definitionen av en åtgärds grupp. I ServiceNow dokument information finns information om hur du skapar mallar – (här) [ https://docs.servicenow.com/bundle/paris-platform-administration/page/administer/form-administration/task/t_CreateATemplateUsingTheTmplForm.html ].

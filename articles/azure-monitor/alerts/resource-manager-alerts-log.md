...
I följande exempel skapas en [rad resultat varnings regel](../alerts/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Kommentarer

- I det här exemplet ingår en [webhook-nyttolast](../alerts/alerts-log-webhook.md). Om varnings regeln inte ska utlösa en webhook tar du bort **customWebhookPayload** -elementet.
...
I följande exempel skapas en [varnings regel för mått mått](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).

...
![Lista över ändrings historik för en händelse](media/activity-log/change-history-event.png)
...
![Sidan ändrings historik visar skillnader](media/activity-log/change-history-event-details.png)
...
3. Klicka på **Diagnostikinställningar**.
   ...
   ![Diagnostikinställningar](media/activity-log/diagnostic-settings.png)

4. Klicka på den lila banderollen för den äldre upplevelsen.

    ![Äldre miljö](media/activity-log/legacy-experience.png)
...
1. Klicka på den prenumeration som du vill ansluta.
    ...
    ![Skärm bild som visar Log Analytics arbets yta med en Azure aktivitets logg vald.](media/activity-log/workspaces.png)

2. Klicka på **Anslut** för att ansluta aktivitets loggen i prenumerationen till den valda arbets ytan. Om prenumerationen redan är ansluten till en annan arbets yta, klickar du på **Koppla från** först för att koppla bort den.

    ![Anslut arbets ytor](media/activity-log/connect-workspace.png)
...
![Panel för Azure aktivitets loggar](media/activity-log/azure-activity-logs-tile.png)
...
![Instrument panel för Azure aktivitets loggar](media/activity-log/activity-log-dash.png)

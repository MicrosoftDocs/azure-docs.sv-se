---
title: Snabb start för Media Services python Basic encoding
description: Den här snabb starten visar hur du utför grundläggande kodning med python och Azure Media Services.
...
ms.locfileid: "102185463"
---
# <a name="media-services-basic-encoding-with-python"></a>Media Services Basic encoding med python

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

## <a name="introduction"></a>Introduktion

Den här snabb starten visar hur du utför grundläggande kodning med python och Azure Media Services. Den använder 2020-05-01 media service v3 API.

## <a name="prerequisites"></a>Krav

- Om du inte har en Azure-prenumeration kan du skapa ett [kostnadsfritt konto](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) innan du börjar.
- Skapa en resurs grupp som ska användas med den här snabb starten.
- Skapa ett Media Services v3-konto.
- Hämta din lagrings konto nyckel.
- Skapa ett huvud namn för tjänsten och en nyckel.

## <a name="get-the-sample"></a>Hämta exemplet

Skapa en förgrening och klona exemplet som finns i [lagrings platsen python-exempel](https://github.com/Azure-Samples/media-services-v3-python). I den här snabb starten arbetar vi med BasicEncoding-exemplet.

## <a name="create-the-env-file"></a>Skapa. kuvert-filen

Hämta värdena från ditt konto för att skapa en *. kuvert* -fil. Det stämmer, spara det utan namn, bara tillägget.  Använd *Sample. kuvert* som mall och spara *. miljö* filen i mappen BasicEncoder i din lokala klon.

## <a name="try-the-code"></a>Testa koden

Koden nedan är väl kommenterad.  Använd hela skriptet eller Använd delar av det för ditt eget skript.

I det här exemplet genereras ett slumpmässigt nummer för namngivning av saker, så att du kan identifiera dem som en grupp som skapats tillsammans när du körde skriptet.  Det slumpmässiga numret är valfritt och kan tas bort när du har testat skriptet.

Vi använder inte SAS-URL: en för ingångs till gången i det här exemplet.
...
När du är klar med snabb starten tar du bort de resurser som har skapats i resurs gruppen.

## <a name="next-steps"></a>Nästa steg

Bekanta dig med [Media Services python SDK](https://docs.microsoft.com/python/api/azure-mgmt-media/?view=azure-python)
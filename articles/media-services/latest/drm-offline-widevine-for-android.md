...
Om du vill aktivera **offline** -läge för Widevine-licenser måste du konfigurera [licens mal len för Widevine](drm-widevine-license-template-concept.md). I **policy_overrides** -objektet anger du egenskapen **can_persist** till **True** (standard är falskt), som du ser i [ConfigureWidevineLicenseTempate](https://github.com/Azure-Samples/media-services-v3-dotnet-tutorials/blob/master/AMSV3Tutorials/EncryptWithDRM/Program.cs#L563). 
...
För vissa äldre Android-enheter måste du ange värden för följande **policy_overrides** egenskaper (definieras i [Widevine-licens mal len](drm-widevine-license-template-concept.md): **rental_duration_seconds**, **playback_duration_seconds** och **license_duration_seconds**. Du kan också ställa in dem på noll, vilket innebär oändlig/obegränsad varaktighet.  
...
Mer information finns i [Widevine i samlingen frågor](questions-collection.md#widevine-streaming-for-android).

...
![Hastighets förvrängnings kurva (RD) med PSNR](media/encode-content-aware-concept/msrv1.png)

**Bild 1: hastighets förvrängning (RD) kurva med PSNR mått för hög komplexitets källa**

![Hastighets förvrängnings kurva (RD) med VMAF](media/encode-content-aware-concept/msrv2.png)
...
![RD-kurva med PSNR](media/encode-content-aware-concept/msrv3.png)

**Bild 3: RD-kurva som använder PSNR för låg kvalitets ineffekt (på 1080p)**

![RD-kurva med VMAF](media/encode-content-aware-concept/msrv4.png)

...
Om du inte vet hur du ska hämta ditt klient-ID och din prenumerations-ID kan du läsa [så här hittar du klient-ID](setup-azure-tenant-how-to.md) och [letar efter klient-ID](setup-azure-tenant-how-to.md).
...
[Så här skapar du en till gång](asset-create-asset-how-to.md)

...
Information om vilka inställningar som är giltiga för din live event-typ finns i [jämförelse av aktiva händelse typer](live-event-types-comparison-reference.md).
...
[Direktsänd strömning med Media Services v3](stream-live-streaming-concept.md)

## <a name="next-steps"></a>Nästa steg

[Så här verifierar du din kodare](encode-on-premises-encoder-partner.md)

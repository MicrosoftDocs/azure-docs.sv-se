...
MS. service: Media-Services MS. arbets belastning: Media ms.tgt_pltfrm: na MS. devlang: na MS. topic: självstudie MS. Date: 03/17/2021 MS. author: inhenkel
...
Du kan kryptera varje tillgång med flera krypteringstyper (AES-128, PlayReady, Widevine, FairPlay). I dokumentationen om [direktuppspelningsprotokoll och krypteringstyper](drm-content-protection-concept.md#streaming-protocols-and-encryption-types) ser du vad som är bra att kombinera. Se även [hur du skyddar med DRM](drm-protect-with-drm-tutorial.md).
...
> [Skydda med DRM](drm-protect-with-drm-tutorial.md)

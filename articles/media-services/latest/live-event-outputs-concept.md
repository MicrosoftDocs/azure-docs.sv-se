...
Mer information finns i [händelse tillstånd och fakturering](live-event-states-billing-concept.md).
...
* När du skapar händelsen kan du välja att aktivera Live-avskrifter. Direkt avskrift är inaktive rad som standard. Mer information om Live-avskrifter finns i [Live-avskrifter](live-event-live-transcription-how-to.md).
...
Detaljerad information om direktsända utdata finns i [använda en moln-DVR](live-event-cloud-dvr-time-how-to.md).

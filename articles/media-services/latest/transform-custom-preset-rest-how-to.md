---
title: Koda en anpassad transformering REST
...
- [Skapa ett Media Services-konto](./account-create-how-to.md). <br/>Kom ihåg att komma ihåg resurs gruppens namn och namnet på Media Services kontot. 
- [Konfigurera PostMan för Azure Media Services REST API-anrop](setup-postman-rest-how-to.md).<br/>Kontrol lera att du följer det sista steget i avsnittet [Hämta Azure AD-token](setup-postman-rest-how-to.md#get-azure-ad-token). 

...
| --- | --- |
| [Media Services konton](account-move-account-how-to.md) i en enda prenumeration | 100 (fast) |
...
| Resurs | Standardgräns | 
| --- | --- | 
| [Jobb](transform-jobs-concept.md) per Media Services konto | 500 000 <sup>(3)</sup> (fast)|
| Jobb indata per jobb | 50 (fast)|
| Jobbets utdata per jobb | 20 (fast) |
| [Transformeringar](transform-jobs-concept.md) per Media Services konto | 100 (fast)|
...
| Resurs | Standardgräns | 
| --- | --- | 
| [Live-händelser](live-event-outputs-concept.md) <sup>(4)</sup> per Media Services konto |5|
| Live-utdata per Live-händelse |3 <sup>(5)</sup> |
| Maximal varaktighet för Live-utdata | [Storlek på DVR-fönstret](live-event-cloud-dvr-time-how-to.md) |

<sup>4</sup> mer detaljerad information om gränser för Live-händelser finns i [jämförelse och gränser för live event types](live-event-types-comparison-reference.md).
...
| Resurs | Standardgräns |
| --- | --- |
| [Slut punkter för direkt uppspelning](stream-streaming-endpoint-concept.md) (stoppad eller igång) per Media Services konto | 2 |
| Premium enheter för strömning | 10 |
| [Filter för dynamiskt manifest](filters-dynamic-manifest-concept.md)|100|
| [Strömmande principer](stream-streaming-policy-concept.md) | 100 <sup>(6)</sup> |
| Unika [strömmande positionerare](stream-streaming-locators-concept.md) som är associerade med en till gång vid ett tillfälle | 100<sup>(7)</sup> (fast) |
...
| Resurs | Standardgräns |
| --- | --- |
| Alternativ per [innehålls nyckel princip](drm-content-key-policy-concept.md) |30 |

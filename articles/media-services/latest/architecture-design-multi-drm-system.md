...
![DRM-undersystem med CENC](./media/architecture-design-multi-drm-system/media-services-generic-drm-subsystem-with-cenc.png)
...
![CENC på Media Services](./media/architecture-design-multi-drm-system/media-services-cenc-subsystem-on-AMS-platform.png)
...
* Lägg till behörigheter för programmet i Azure AD på fliken **Konfigurera** i programmet. Behörigheter krävs för varje program, både lokala och distribuerade versioner.
    ...
    ![Behörigheter](./media/architecture-design-multi-drm-system/media-services-perms-to-other-apps.png)
...
![Anpassat Azure AD-klientens domän konto ett](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain1.png)

**Microsoft-domännamn med smartkort**: inloggnings sidan som anpassats av Microsoft Corporate IT med tvåfaktorautentisering.

![Anpassat Azure AD-klientens domän konto två](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain2.png)

**Microsoft-konto**: inloggnings sidan för Microsoft-konto för konsumenter.

![Anpassat Azure AD-klientens domän konto tre](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain3.png)
...
![Använd EME för PlayReady](./media/architecture-design-multi-drm-system/media-services-eme-for-playready1.png)
...
![Windows Media Player-plugin-program för PlayReady](./media/architecture-design-multi-drm-system/media-services-eme-for-playready2.png)
...
![Använd EME för Widevine](./media/architecture-design-multi-drm-system/media-services-eme-for-widevine1.png)

Widevine hindrar dig inte från att göra en skärm bild av skyddad video.

![Spelare-plugin-program för Widevine](./media/architecture-design-multi-drm-system/media-services-eme-for-widevine2.png)
...
![Obehöriga användare](./media/architecture-design-multi-drm-system/media-services-unentitledusers.png)
...
![Anpassad STS med en symmetrisk nyckel](./media/architecture-design-multi-drm-system/media-services-running-sts1.png)
...
![Anpassad STS med en asymmetrisk nyckel](./media/architecture-design-multi-drm-system/media-services-running-sts2.png)

---
title: Azure Policy för regelefterlevnad för Azure Arc-aktiverade servrar (förhandsversion)
description: Visar Azure Policy för regelefterlevnad som är Azure Arc aktiverade servrar (förhandsversion). Dessa inbyggda principdefinitioner tillhandahåller vanliga metoder för att hantera kompatibiliteten för dina Azure-resurser.
ms.date: 04/14/2021
ms.topic: sample
...
---
# <a name="azure-policy-regulatory-compliance-controls-for-azure-arc-enabled-servers"></a>Azure Policy för regelefterlevnad för Azure Arc aktiverade servrar

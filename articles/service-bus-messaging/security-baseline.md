...
ms.locfileid: "105967820"
---
# <a name="azure-security-baseline-for-service-bus"></a>Azures säkerhets bas linje för Service Bus

Den här säkerhets bas linjen använder vägledning från [Azures säkerhets benchmark-version 1,0](../security/benchmarks/overview-v1.md) till Service Bus. Azure Security Benchmark ger rekommendationer om hur du kan skydda dina molnlösningar i Azure. Innehållet grupperas efter de **säkerhets kontroller** som definieras av Azures säkerhets benchmark och relaterade rikt linjer som gäller för Service Bus. **Kontroller** som inte är tillämpliga på Service Bus, eller för vilka ansvaret är Microsofts, har uteslutits.
...
**Azure policy inbyggda definitioner – Microsoft. Service Bus**:
...
- [Inbyggd Azure-princip för Service Bus namnrymd](https://docs.microsoft.com/azure/service-bus-messaging/policy-reference#azure-service-bus-messaging)
...
- [Inbyggda roller för Azure Service Bus](https://docs.microsoft.com/azure/service-bus-messaging/authenticate-application#azure-built-in-roles-for-azure-service-bus)
...
**Vägledning**: Aktivera Azure Active Directory (Azure AD) multifaktorautentisering och Azure Security Center Följ rekommendationerna för identitets-och åtkomst hantering som hjälper dig att skydda dina Service Bus-aktiverade resurser.
...
**Vägledning**: Använd Privileged Access-arbetsstationer (Paw) med multifaktorautentisering konfigurerad för att logga in på och konfigurera Service Bus-aktiverade resurser.
...
**Vägledning**: Använd Azure Active Directory (Azure AD) som central autentiserings-och auktoriserings system för Azure-resurser som Service Bus. Detta möjliggör Azure-rollbaserad åtkomst kontroll (Azure RBAC) till administrativa känsliga resurser.

- [Skapa och konfigurera en Azure AD-instans](../active-directory/fundamentals/active-directory-access-create-new-tenant.md)

- [Ge åtkomst till Service Bus resurser med hjälp av Azure AD](authenticate-application.md)
...
**Vägledning**: Använd Azure Active Directory (Azure AD) för identitets skydd och identifiering av risker för att konfigurera automatiserade svar på identifierade misstänkta åtgärder som rör dina Service Bus-aktiverade resurser. Du bör aktivera automatiserade svar via Azure Sentinel för att implementera din organisations säkerhets svar.
...
- [Autentisera en hanterad identitet med Azure Active Directory (Azure AD) för att få åtkomst till Service Bus resurser](service-bus-managed-service-identity.md)
...
- [Autentisera en hanterad identitet med Azure AD för att få åtkomst till Service Bus resurser](service-bus-managed-service-identity.md)

...
description: Visar Azure Policy för regelefterlevnad som är tillgängliga för Azure Data Box. Dessa inbyggda principdefinitioner ger vanliga metoder för att hantera kompatibiliteten för dina Azure-resurser.
ms.date: 04/14/2021
ms.topic: sample
author: alkohli
ms.author: alkohli

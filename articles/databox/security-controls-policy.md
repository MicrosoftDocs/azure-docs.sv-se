---
title: Azure Policy för regelefterlevnad för Azure Data Box
description: Visar Azure Policy kontroller för regelefterlevnad som är tillgängliga för Azure Data Box. Dessa inbyggda principdefinitioner ger vanliga metoder för att hantera kompatibiliteten för dina Azure-resurser.
ms.date: 04/21/2021
ms.topic: sample
author: alkohli
ms.author: alkohli

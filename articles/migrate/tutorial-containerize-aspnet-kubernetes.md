---
title: Använd ASP.NET-program och migrera till Azure Kubernetes service
description: Lär dig hur du Använd ASP.NET-program och migrerar till Azure Kubernetes service.
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial

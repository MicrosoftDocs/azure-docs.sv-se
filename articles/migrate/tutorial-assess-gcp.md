---
title: Utvärdera GCP VM-instanser för migrering till Azure med Azure Migrate
description: Beskriver hur du bedömer GCP VM-instanser för migrering till Azure med hjälp av Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Den här artikeln visar hur du bedömer Google Cloud Platform (GCP) VM-instanser för migrering till Azure med hjälp av verktyget Azure Migrate: identifiering och bedömning.
...
Bestäm om du vill köra en utvärdering med storleks kriterier baserat på Server konfigurations data/metadata som samlas in lokalt eller baserat på prestanda data.

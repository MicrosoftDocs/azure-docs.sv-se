---
title: Använd Java Web Apps-program och migrera till Azure Kubernetes-tjänsten
description: Lär dig hur du Använd Java-webbprogram och migrerar till Azure Kubernetes-tjänsten.
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial

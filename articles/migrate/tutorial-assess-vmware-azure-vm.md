---
title: Utvärdera VMware-servrar för migrering till virtuella Azure-datorer i Azure Migrate
description: Lär dig hur du bedömer VMware-servrar för migrering till virtuella Azure-datorer med Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Den här artikeln visar hur du bedömer identifierade servrar från din VMware-miljö som förberedelse för migrering till virtuella Azure-datorer med hjälp av verktyget Azure Migrate: identifiering och bedömning.

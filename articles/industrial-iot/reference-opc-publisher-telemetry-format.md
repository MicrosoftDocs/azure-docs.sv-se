---
title: Microsoft OPC Publisher telemetri-format
description: Den här artikeln innehåller en översikt över filen med konfigurations inställningar
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787586"
---
# <a name="opc-publisher-telemetry-format"></a>OPC Publisher telemetri-format

OPC Publisher version 2,6 och senare har stöd för standardiserad OPC UA PubSub JSON-format enligt vad som anges i [del 14 i OPC UA-specifikationen](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) och ser ut så här:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Dessutom stöder alla versioner av OPC Publisher ett icke standardiserat, enkelt JSON telemetri-format, som är kompatibelt med [Azure Time Series Insights](https://azure.microsoft.com/services/time-series-insights/) och ser ut så här:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>OPC Publisher telemetri konfigurations fil format
```

...
Mer information om isolerings nivåer och transaktionella gränser finns i [transaktioner i dedikerad SQL-pool](develop-transactions.md) .  En översikt över andra bästa metoder finns i [metod tips för dedikerad SQL-pool](best-practices-dedicated-sql-pool.md).

...
| Azure Machine Learning (Microsoft. MachineLearningServices/arbetsytes)/amlworkspace | privatelink.api.azureml.ms<br/>privatelink.notebooks.azure.net | api.azureml.ms<br/>notebooks.azure.net<br/>aznbcontent.net |

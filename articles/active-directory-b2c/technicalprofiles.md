...
1. **Transformering av inmatade anspråk** – innan den tekniska profilen startas körs inmatade Azure AD B2C [anspråks omvandling]. (claimstransformations.md).

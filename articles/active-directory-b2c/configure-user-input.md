...
1. Under **användarattribut** väljer du **ort**.
    1. I list rutan **typ av Indatatyp** väljer du **DropdownSingleSelect**. Valfritt: Använd knapparna Flytta upp/ned för att ordna text ordningen på registrerings sidan.

...
För att verifiera användarindata anropas en [verifiering av tekniska profiler](validation-technical-profile.md) från den självkontrollerade tekniska profilen. 

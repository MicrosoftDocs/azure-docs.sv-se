...
- `<application-ID-URI>` – Den URI för program-ID som du anger under **exponera ett API** -blad i klient programmet.
- `<scope-name>` – Namnet på den omfattning som du lade till under **exponera ett API** -blad i klient programmet.

...
| token_signing_algorithm | Nej | Signeringsalgoritmen som används för klient kontroll när **token_endpoint_auth_method** metadata har angetts till `private_key_jwt` . Möjliga värden: `RS256` (standard). |

...
* [Använd hanterad identitet (förhands granskning) för att autentisera ditt Azure Stream Analytics jobb till Azure Blob Storage](blob-output-managed-identity.md)

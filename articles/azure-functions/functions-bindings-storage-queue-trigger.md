...
[QueueTrigger](/java/api/com.microsoft.azure.functions.annotation.queuetrigger) -anteckningen ger dig åtkomst till det Queue meddelande som utlöste funktionen.

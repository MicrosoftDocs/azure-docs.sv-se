---
title: Utveckla klass biblioteks funktioner i C# med hjälp av Azure Functions
description: Lär dig hur du använder C# för att utveckla och publicera kod som klass bibliotek som körs i processen med Azure Functions Runtime.
ms.topic: conceptual
...
ms.locfileid: "102563888"
---
# <a name="develop-c-class-library-functions-using-azure-functions"></a>Utveckla klass biblioteks funktioner i C# med hjälp av Azure Functions

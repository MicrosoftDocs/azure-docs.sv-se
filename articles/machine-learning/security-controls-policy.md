---
title: Azure Policy för regelefterlevnad för Azure Machine Learning
description: Visar Azure Policy för regelefterlevnad som är tillgängliga för Azure Machine Learning. Dessa inbyggda principdefinitioner tillhandahåller vanliga metoder för att hantera kompatibiliteten för dina Azure-resurser.
ms.date: 04/21/2021
ms.topic: sample
author: BlackMist
ms.author: larryfr
...
ms.locfileid: "107877774"
---
# <a name="azure-policy-regulatory-compliance-controls-for-azure-machine-learning"></a>Azure Policy för regelefterlevnad för Azure Machine Learning

...
| Kategori | Värde |
| ------------- | ------------- |
| Version (er) som stöds | 1.2.0 (Ubuntu 16,04), 1.7.1 (Ubuntu 18,04, Windows 2019) |
| DSVM-versioner som stöds      | Windows Server 2019<br>Ubuntu 18.04<br> Ubuntu 16.04 |
| Hur konfigureras den/installeras på DSVM?  | Installeras i [Python 3,7](dsvm-tools-languages.md#python-linux-edition) i py37_pytorch Conda-miljön. Exempel på Jupyter-anteckningsböcker ingår och exempel finns i/dsvm/samples/pytorch. |
...
| Så här kör du det      |  Exempel är tillgängliga [online](https://www.tensorflow.org/tfx/guide/serving).   |

...
När dina data har för berett, lär du dig hur du [utnyttjar ett Synase Spark-kluster som ett beräknings mål för modell träning](https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/azure-synapse/spark_job_on_synapse_spark_pool.ipynb).

I den här [exempel antecknings boken](https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/azure-synapse/spark_session_on_synapse_spark_pool.ipynb) finns ytterligare begrepp och demonstrationer av funktionerna i Azure Synapse Analytics och Azure Machine Learning integration.

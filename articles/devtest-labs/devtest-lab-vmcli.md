...
* [Installera Azure CLI.](/cli/azure/install-azure-cli) Starta genom att köra az login för att skapa en anslutning till Azure. 
...
Du kan också skapa virtuella datorer baserat på formler genom att ange **parametern avbildningstyp** till **formeln**. Om du behöver välja ett specifikt virtuellt nätverk för den virtuella datorn använder du **parametrarna vnet-name** **och subnet.** Mer information finns i [az lab vm create](/cli/azure/lab/vm#az_lab_vm_create).
...
**Cloud Shell – Bash:** observera användningen av snedstreck ( \\ ) framför $ i kommandot. 

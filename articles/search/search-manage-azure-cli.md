...
Mer information om hur du skapar privata slut punkter i PowerShell finns i den här snabb starten för [privata länkar](../private-link/create-private-endpoint-cli.md)

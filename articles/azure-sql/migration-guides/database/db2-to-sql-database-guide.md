...
ms.locfileid: "105027099"
---
# <a name="migration-guide-db2-to-azure-sql-database"></a>Migration guide: DB2 till Azure SQL Database
...
1. Anslut till databasen i Azure SQL Database genom att använda [SQL Server Management Studio](/sql/ssms/download-sql-server-management-studio-ssms) och verifiera migreringen genom att granska data och schema:

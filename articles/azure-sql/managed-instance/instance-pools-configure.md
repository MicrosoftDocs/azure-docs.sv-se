...
> [!NOTE]
> För att kontrol lera antalet databaser per instans och hanterad instans som distribueras i avsnittet om [resurs gränser för instansen för instansen](instance-pools-overview.md#resource-limitations) av pooler.

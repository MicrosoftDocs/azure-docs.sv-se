...
description: Lär dig hur du svarar på ett potentiellt komprometterat TDE-skydd för Azure SQL Database-eller Azure Synapse-analys med hjälp av TDE med stöd för Bring Your Own Key (BYOK).

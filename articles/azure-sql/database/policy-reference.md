...
ms.locfileid: "107498105"
---
# <a name="azure-policy-built-in-definitions-for-azure-sql-database--sql-managed-instance"></a>Azure Policy inbyggda definitioner för Azure SQL Database & SQL Managed Instance
[!INCLUDE[appliesto-sqldb-sqlmi-asa](../includes/appliesto-sqldb-sqlmi-asa.md)]

Den här sidan är ett index [Azure Policy](../../governance/policy/overview.md) inbyggda principdefinitioner för Azure SQL Database och SQL Managed Instance. Ytterligare Azure Policy inbyggda funktioner för andra tjänster finns i [Azure Policy inbyggda definitionerna](../../governance/policy/samples/built-in-policies.md).
...
- Azure Policy gäller för en Azure SQL Database skapas inte när du använder T-SQL eller SSMS. 

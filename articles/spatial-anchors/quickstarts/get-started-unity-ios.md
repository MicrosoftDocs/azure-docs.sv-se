...
Följ anvisningarna [här](../how-tos/setup-unity-project.md#download-asa-packages) för att hämta och importera de ASA SDK-paket som krävs för iOS-plattformen.

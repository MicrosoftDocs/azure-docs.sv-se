...
Den här artikeln visar hur du konfigurerar en zon – redundant behållar register eller zon-redundant replik med hjälp av Azure Portal eller en Azure Resource Manager mall. 
...
1. På kartan som visas väljer du en grön sexhörning i en region som stöder zon redundans för Azure Container Registry, till exempel **västra USA 2**. Välj sedan **Skapa**.
1. I fönstret **skapa replikering** i **tillgänglighets zoner** väljer du **aktive rad** och väljer sedan **skapa**.
...
Du kan använda följande Resource Manager-mall för att skapa ett zon redundant, geo-replikerat register. Mallen som standard aktiverar zon-redundans i registret och en ytterligare regional replik. 

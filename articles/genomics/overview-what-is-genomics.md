...
description: Lär dig hur Microsoft Genomics kan sätta igång genom att använda en moln implementering av Burrows-Wheelers justering (BWA) och användas (genom att analysera analys verktyg).
services: genomics
author: grhuynh
manager: cgronlun
ms.author: grhuynh
...
Microsoft Genomics erbjuder en moln implementering av Burrows-Wheelers justeringen (BWA) och användas (genom analys verktyg) för sekundär analys. Tjänsten är ISO-certifierad och kompatibel med HIPAA-förordningar och har pris för bruk för dina behov. Lär dig hur du använder tjänsten Microsoft Genomics och integrerar med vår API genom att läsa våra snabb starter, självstudier och dokumentation.

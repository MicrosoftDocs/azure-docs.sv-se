...
När du har skapat slut punkts resurserna kan du använda dem för en Azure digital-slutpunkt. I följande exempel visas hur du skapar slut punkter med hjälp av kommandot [AZ DT Endpoint Create](/cli/azure/dt/endpoint/create) för [Azure Digitals flätat CLI](how-to-use-cli.md). Ersätt plats hållarna i kommandona med information om dina egna resurser.
...
Om du vill skapa en slut punkt där obeställbara meddelanden har Aktiver ATS lägger du till följande död bokstavs parameter i kommandot [AZ DT Endpoint Create](/cli/azure/dt/endpoint/create) för [Azure Digitals CLI](how-to-use-cli.md).
...
Här är ett exempel på ett meddelande om obeställbara meddelanden för ett [dubbelt skapande meddelande](concepts-event-notifications.md#digital-twin-lifecycle-notifications):
...
Händelse vägar kan skapas med Azure Digitals dubbla [ **EventRoutes** data Plans-API: er](/rest/api/digital-twins/dataplane/eventroutes) eller [ **AZ DT Route** CLI-kommandon](/cli/azure/dt/route). Resten av det här avsnittet beskriver hur du skapar processen.
...
Vägar kan också hanteras med [AZ DT Route](/cli/azure/dt/route) -kommandon för Azure Digitals flätat-cli. 
...
* [*Koncept: händelse meddelanden*](concepts-event-notifications.md)

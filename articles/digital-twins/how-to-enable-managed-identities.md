---
title: Aktivera en hanterad identitet för vägvals händelser (för hands version)
titleSuffix: Azure Digital Twins
description: Se hur du aktiverar en tilldelad identitet för Azure Digitals och använder den för att vidarebefordra händelser.
author: baanders
ms.author: baanders
ms.date: 1/21/2021
ms.topic: how-to
...
ms.locfileid: "98948881"
---
# <a name="enable-a-managed-identity-for-routing-azure-digital-twins-events-preview"></a>Aktivera en hanterad identitet för routning av Azure Digitals sammanflätade händelser (för hands version)
...
I det här avsnittet ska du använda [Azure Portal](https://portal.azure.com) för att lägga till en Systemhanterad identitet till en Azure Digital-instansen som redan finns.

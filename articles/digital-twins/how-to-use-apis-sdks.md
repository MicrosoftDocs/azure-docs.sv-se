...
* Du kan för närvarande komma åt SDK: er för kontroll-API: er i...
  ...
  - [**Java**](https://search.maven.org/search?q=a:azure-mgmt-digitaltwins) ([referens [automatiskt genererad]](/java/api/overview/azure/digitaltwins?view=azure-java-stable&preserve-view=true)) ([källa](https://github.com/Azure/azure-sdk-for-java/tree/master/sdk/digitaltwins))

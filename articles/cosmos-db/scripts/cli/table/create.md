...
ms.locfileid: "107789000"
---
# <a name="create-an-azure-cosmos-table-api-account-and-table-using-azure-cli"></a>Skapa ett Azure Cosmos Tabell-API konto och en tabell med Hjälp av Azure CLI

...
ms.locfileid: "107770713"
---
# <a name="create-an-azure-cosmos-gremlin-api-account-database-and-graph-using-azure-cli"></a>Skapa ett Azure Cosmos Gremlin API-konto, en databas och en graf med Azure CLI

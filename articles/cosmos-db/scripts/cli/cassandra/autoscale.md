---
title: Skapa ett Cassandra-nyckelutrymme och en tabell med autoskalning för Azure Cosmos DB
description: Skapa ett Cassandra-nyckelutrymme och en tabell med autoskalning för Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "107786879"
---
# <a name="create-an-azure-cosmos-cassandra-api-account-keyspace-and-table-with-autoscale-using-azure-cli"></a>Skapa ett Azure Cosmos API för Cassandra-konto, nyckelutrymme och tabell med autoskalning med Hjälp av Azure CLI

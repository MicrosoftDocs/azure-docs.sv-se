---
title: Skapa ett Cassandra-nyckelutrymme och en tabell för Azure Cosmos DB
description: Skapa ett Cassandra-nyckelutrymme och en tabell för Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "107786881"
---
# <a name="create-an-azure-cosmos-cassandra-api-account-keyspace-and-table-using-azure-cli"></a>Skapa ett Azure Cosmos API för Cassandra konto, nyckelutrymme och en tabell med Azure CLI

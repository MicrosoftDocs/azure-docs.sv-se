...
* En bugg har åtgärd ATS vid hantering av en fråga via tjänst-Interop.

### <a name="260"></a><a name="2.6.0"></a>2.6.0
* Stöd har lagts till för att skicka frågor till ändrings flöde från tidpunkt.

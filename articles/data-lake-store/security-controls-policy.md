---
title: Azure Policy för regelefterlevnad för Azure Data Lake Storage Gen1
description: Visar Azure Policy för regelefterlevnad som är tillgängliga för Azure Data Lake Storage Gen1. Dessa inbyggda principdefinitioner ger vanliga metoder för att hantera kompatibiliteten för dina Azure-resurser.
ms.date: 04/14/2021
ms.topic: sample
author: normesta
ms.author: normesta

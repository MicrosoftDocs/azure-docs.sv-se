...
Skapa Front Door med [az network front-door create](/cli/azure/network/front-door#az_network_front_door_create&preserve-view=true):
...
**--accepted-protocols:** Godkända värden är **http** och **https**. Om du vill använda båda, avgränsas båda med ett blanksteg.

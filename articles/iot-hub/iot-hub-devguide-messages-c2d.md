...
Systemet skickar feedback antingen när batchen når 64 meddelanden eller i 15 sekunder från det senaste skickade, beroende på vilket som kommer först. 
...
| Description        | Sträng värden för *StatusCode* |

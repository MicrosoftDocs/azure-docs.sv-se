---
title: Självstudie – uppdatera enhetens inbyggda program vara via Azure IoT Hub | Microsoft Docs
description: Självstudie – lär dig hur du implementerar en uppdaterings process för enhetens inbyggda program vara som kan utlösas från ett Server dels program som är anslutet till din IoT Hub.
services: iot-hub
author: wesmc7777
ms.author: wesmc
ms.service: iot-hub
...
Du skapar en [Automatisk enhets hanterings konfiguration](iot-hub-automatic-device-management.md#create-a-configuration) i Server dels programmet för att starta uppdaterings processen för den inbyggda program varan på alla enheter som är märkta med **enhets typen** kylning. I det här avsnittet visas hur du:

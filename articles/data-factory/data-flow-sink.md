...
När du hämtar en data förhands granskning i fel söknings läge skrivs inga data till din mottagare. En ögonblicks bild av hur data ser ut kommer att returneras, men inget skrivs till ditt mål. Om du vill testa att skriva data i din mottagare kan du köra en pipeline-felsökning från pipeline-arbetsytan.

## <a name="data-flow-script"></a>Dataflödesskript

### <a name="example"></a>Exempel

Nedan visas ett exempel på en Sink-omvandling och dess data flödes skript:

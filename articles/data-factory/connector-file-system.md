...
> [!NOTE]
> Mappad nätverks enhet stöds inte vid inläsning av data från en nätverks fil resurs. Använd den faktiska sökvägen istället. ` \\server\share` ..

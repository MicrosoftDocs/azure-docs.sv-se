...
> [!NOTE]
> `-deleteDeployment`Flaggan används för att ange borttagning av den automatiska distributions posten från distributions historiken i arm.

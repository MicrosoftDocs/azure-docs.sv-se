---
title: Automatisk värd för integration runtime, automatisk uppdatering och förfallo datum för avisering
...
ms.locfileid: "98122663"
---
# <a name="self-hosted-integration-runtime-auto-update-and-expire-notification"></a>Automatisk värd för integration runtime, automatisk uppdatering och förfallo datum för avisering
...
![Aktivera automatisk uppdatering](media/create-self-hosted-integration-runtime/shir-auto-update-2.png)

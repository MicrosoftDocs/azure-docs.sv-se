...
ms.locfileid: "107364557"
---
# <a name="azure-key-vault-developers-guide"></a>Utvecklarguide för Azure Key Vault

Key Vault kan du på ett säkert sätt komma åt känslig information i dina program:
...
- Programmet kan använda nycklar för signering och kryptering men behåller nyckelhanteringen externt från ditt program. Mer information om nycklar finns i [Om nycklar](../keys/about-keys.md)
...
Med jämna mellanrum släpper vi en offentlig förhandsversion av en Key Vault funktion. Prova funktionerna i den offentliga förhandsversionen och berätta vad du tycker via azurekeyvault@microsoft.com , vår e-postadress för feedback.
...
Mer information om Key Vault finns i Key Vault [hanteringsplanet](./secure-your-key-vault.md#management-plane-and-azure-rbac)
...
Åtkomst till nycklar, hemligheter och certifikat styrs av dataplanet. Åtkomstkontroll för dataplanet kan göras med åtkomstprinciper för lokala valv eller Azure RBAC.
...
Mer information om Key Vault dataplansäkerhet finns [i Key Vault dataplan](./secure-your-key-vault.md#data-plane-and-access-policies) och åtkomstprinciper och [Key Vault dataplanet och Azure RBAC](./secure-your-key-vault.md#data-plane-and-azure-rbac)

### <a name="code-examples"></a>Kodexempel

Fullständiga exempel med hjälp Key Vault med dina program finns i:
...
- [Åtkomst Key Vault bakom brandväggen](access-behind-firewall.md) – För att få åtkomst till ett nyckelvalv måste ditt klientprogram för nyckelvalvet kunna komma åt flera mål för olika funktioner.
- Hur du distribuerar certifikat till virtuella datorer Key Vault [– Windows](../../virtual-machines/extensions/key-vault-windows.md), [Linux](../../virtual-machines/extensions/key-vault-linux.md) – Ett molnprogram som körs på en virtuell dator på Azure behöver ett certifikat. Hur hämtar du det här certifikatet till den här virtuella datorn idag?

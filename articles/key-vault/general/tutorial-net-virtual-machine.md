...
Tilldela de tidigare skapade identitetsbehörigheterna till nyckelvalvet med [kommandot az keyvault set-policy:](/cli/azure/keyvault#az-keyvault-set-policy)
...
Om du vill installera .NET Core går du till [nedladdningssidan för .NET.](https://www.microsoft.com/net/download)

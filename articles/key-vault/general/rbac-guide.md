...
## <a name="azure-built-in-roles-for-key-vault-data-plane-operations"></a>Inbyggda roller i Azure Key Vault åtgärder på dataplanet
> [!NOTE]
...
> [!NOTE]
> Webbläsare använder cachelagring och siduppdatering krävs när rolltilldelningar har tas bort.<br>
> Det kan ta flera minuter innan rolltilldelningarna uppdateras
...
Skapa ny hemlighet ( Hemligheter \> +Generera/Importera) bör visa nedanstående fel:

   ![Skapa ny hemlighet](../media/rbac/image-11.png)

2.  Verifiera hemlighetsredigering utan rollen "Key Vault Secret Officer" på hemlighetsnivå.
...
-   Gå till fliken Åtkomstkontroll (IAM) för nyckelvalvsresursgrupp och ta bort rolltilldelningen "Key Vault Reader".

-   Om du går till key vault-fliken Hemligheter bör du se felet nedan:
...
-   Svarstid för rolltilldelningar: vid aktuella förväntade prestanda tar det upp till 10 minuter (600 sekunder) efter att rolltilldelningar har ändrats för att rollen ska tillämpas

---
title: Åtkomst Key Vault bakom en brandvägg – Azure Key Vault | Microsoft Docs
description: Lär dig mer om de portar, värdar eller IP-adresser som ska öppnas för att aktivera ett nyckelvalvsklientprogram bakom en brandvägg för att få åtkomst till ett nyckelvalv.
services: key-vault
author: amitbapat
...
ms.locfileid: "107751642"
---
# <a name="access-azure-key-vault-behind-a-firewall"></a>Få åtkomst till Azure Key Vault bakom en brandvägg

## <a name="what-ports-hosts-or-ip-addresses-should-i-open-to-enable-my-key-vault-client-application-behind-a-firewall-to-access-key-vault"></a>Vilka portar, värdar eller IP-adresser ska jag öppna för att aktivera mitt nyckelvalvsklientprogram bakom en brandvägg för åtkomst till nyckelvalvet?
...
Om du har frågor om Key Vault kan du gå till [sidan Microsoft Q&A question (Frågor](/answers/topics/azure-key-vault.html)och svar) för Azure Key Vault .
---
title: Viktig information om Azure Stack Edge Pro 2012
description: Beskriver kritiska öppna problem och lösningar för Azure Stack Edge Pro som kör 2012-versionen.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "97364615"
---
# <a name="azure-stack-edge-2012-release-notes"></a>Viktig information om Azure Stack Edge 2012

I följande viktig information identifieras kritiska öppna problem och de lösta problemen för 2012-versionen för dina Azure Stack Edge-enheter. Den här viktig information gäller för Azure Stack Edge Pro GPU, Azure Stack Edge Pro R och Azure Stack Edge Mini R-enheter. Funktioner och problem som motsvarar en speciell modell anropas i tillämpliga fall.
...
Den här artikeln gäller **Azure Stack Edge 2012** -versionen som mappar till program versions nummer **2.2.1438.2470**.

## <a name="whats-new"></a>Nyheter

Följande nya funktioner är tillgängliga i Azure Stack Edge 2012-versionen. 
...
## <a name="known-issues-in-2012-release"></a>Kända problem i 2012-versionen

Följande tabell innehåller en sammanfattning av kända problem i 2012-versionen.

---
title: Uppdatering av enhets uppdateringar för Azure IoT Hub-självstudier för Azure – real tids operativ system | Microsoft Docs
description: Kom igång med enhets uppdatering för Azure IoT Hub med Azure-real tids operativ system
author: valls
ms.author: valls
ms.date: 3/18/2021
ms.topic: tutorial

...
description: Den här artikeln innehåller ett Azure CLI-exempelskript som visar hur du prenumererar på Azure Event Grid händelser med Hjälp av Azure CLI.
ms.devlang: azurecli
ms.topic: sample
ms.date: 07/08/2020

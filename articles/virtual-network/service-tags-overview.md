...
| **AzureDigitalTwins** | Azure Digital Twins.<br/><br/>*Obs!* Den här taggen eller IP-adresserna som omfattas av den här taggen kan användas för att begränsa åtkomsten till slutpunkter som konfigurerats för händelsevägar. *Den här taggen kan för närvarande inte konfigureras via Azure-portalen* | Inkommande | Inga | Ja |

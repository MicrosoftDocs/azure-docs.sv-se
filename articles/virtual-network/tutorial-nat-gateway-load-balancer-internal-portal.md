---
title: 'Självstudie: integrera NAT-gateway med en intern belastningsutjämnare – Azure Portal'
titleSuffix: Virtual Network NAT
description: I den här självstudien lär du dig att integrera en Virtual Network NAT-gateway med en intern belastningsutjämnare med hjälp av Azure Portal.
author: asudbring
ms.author: allensu
...
ms.locfileid: "104670866"
---
# <a name="tutorial-integrate-a-nat-gateway-with-an-internal-load-balancer-using-the-azure-portal"></a>Självstudie: integrera en NAT-gateway med en intern belastningsutjämnare med hjälp av Azure Portal

I den här självstudien får du lära dig hur du integrerar en NAT-gateway med en intern belastningsutjämnare.

Som standard är en Azure-Standard Load Balancer säker. Utgående anslutning definieras explicit genom att aktivera utgående SNAT (käll nätverks adress översättning). 

SNAT är aktiverat för en intern backend-pool via en annan offentlig belastningsutjämnare, nätverks routning eller en offentlig IP-adress som definierats på en virtuell dator.

NAT gateway-integreringen ersätter behovet av distribution av en offentlig belastningsutjämnare, nätverks routning eller en offentlig IP-adress som definierats på en virtuell dator i backend-poolen.
...
3. I **Skapa virtuellt nätverk** anger eller väljer du den här informationen på fliken **grundläggande** :
    ...
    | Resursgrupp   | Välj **Skapa ny**. Ange **TutorIntLBNAT-RG**. </br> Välj **OK**. |
    | **Instansinformation** |                                                                 |
    | Name             | Ange **myVNet**                                    |
...
4. På sidan **skapa belastnings utjämning** anger eller väljer du följande information: 
    ...
    | Resursgrupp         | Välj **TutorIntLBNAT-RG**.|
    | **Instansinformation** |    |
    ...
    | Tillgänglighetszon | Välj **zon-redundant** för att skapa en elastisk belastningsutjämnare. </br> Om du vill skapa en zonindelade-belastningsutjämnare väljer du en speciell zon från 1, 2 eller 3 |
...
2. Anteckna den offentliga IP-adressen:
    ...
    :::image type="content" source="./media/tutorial-nat-gateway-load-balancer-internal-portal/find-public-ip.png" alt-text="Skärm bild av NAT-gatewayens offentliga IP-adress." border="true":::

3. Välj **alla tjänster** i den vänstra menyn, Välj **alla resurser** och välj **myVM1** i resurs gruppen **TutorIntLBNAT-RG** i resurs listan.
...
9. Kontrol lera att den IP-adress som visas matchar NAT-gateway-adressen som du antecknade i föregående steg:
    ...
    :::image type="content" source="./media/tutorial-nat-gateway-load-balancer-internal-portal/my-ip.png" alt-text="Skärm bild av Internet Explorer som visar extern utgående IP." border="true":::
...
2. Välj resurs gruppen **TutorIntLBNAT-RG** .

3. Välj **Ta bort resursgrupp**.

4. Ange **TutorIntLBNAT-RG** och välj **ta bort**.

---
title: Skriptexempel för Azure CLI – Konfigurera IPv6-frontend
titlesuffix: Azure Virtual Network
description: Använd ett Azure CLI-skriptexempel för att konfigurera IPv6-slutpunkter och distribuera ett program med dubbla stackar (IPv4 + IPv6) i Azure.
...
Om du vill använda funktionen för virtuella nätverk i IPv6 för Azure måste du bara konfigurera prenumerationen en gång på följande sätt:

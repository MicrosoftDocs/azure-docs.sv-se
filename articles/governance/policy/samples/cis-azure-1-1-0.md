...
### <a name="ensure-that-activity-log-alert-exists-for-update-security-policy"></a>Kontrollera att aktivitetsloggaviseringen finns för Uppdateringssäkerhetsprincip
...
### <a name="ensure-that-the-endpoint-protection-for-all-virtual-machines-is-installed"></a>Kontrollera att slutpunktsskydd för alla Virtual Machines är installerat

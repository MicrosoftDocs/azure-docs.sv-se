...
### <a name="can-a-service-principal-manage-application-proxy-using-powershell-or-microsoft-graph-apis"></a>Kan tjänstens huvud namn hantera programproxy med PowerShell eller Microsoft Graph API: er?

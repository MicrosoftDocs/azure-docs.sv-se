---
title: PowerShell-exempel – Tilldela en användare till en Programproxy app
description: PowerShell-exempel som tilldelar en användare till en Azure Active Directory (Azure AD) Programproxy program.
...
ms.locfileid: "107375584"
---
# <a name="assign-a-user-to-a-specific-azure-ad-application-proxy-application"></a>Tilldela en användare till ett specifikt Azure AD Programproxy program

Med det här PowerShell-skriptexempel kan du tilldela en användare till ett specifikt Azure AD Programproxy program.
...
|---|---|
| [New-AzureADUserAppRoleAssignment](/powershell/module/AzureAD/new-azureaduserapproleassignment) | Tilldelar en användare till en programroll. |

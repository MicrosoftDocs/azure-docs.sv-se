...
De angivna inställningarna som [UserWriteback i Azure AD Connect](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-preview#user-writeback) stöds inte. Inaktivera i inställningarna. 

...
- Om du är intresse rad av att använda Azure Portal för att hantera åtkomst till resurser, se [Självstudier: hantera åtkomst till resurser – Azure Portal](entitlement-management-access-package-first.md).
- Om du är intresse rad av att använda Microsoft Graph för att hantera åtkomst till resurser, se [Självstudier: hantera åtkomst till resurser – Microsoft Graph](/graph/tutorial-access-package-api?toc=/azure/active-directory/governance/toc.json&bc=/azure/active-directory/governance/breadcrumb/toc.json)

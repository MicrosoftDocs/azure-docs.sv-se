...
Detta utdrag är från [MSAL-exemplen för Node dev](https://github.com/AzureAD/microsoft-authentication-library-for-js/tree/dev/samples/msal-node-samples/device-code).

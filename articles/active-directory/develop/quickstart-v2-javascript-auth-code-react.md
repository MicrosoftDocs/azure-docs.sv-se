---
title: 'Snabb start: Logga in användare i Java Script reagerar på appar med en sida (SPA) med auth-kod och anropa Microsoft Graph | Azure'
titleSuffix: Microsoft identity platform
description: I den här snabb starten får du lära dig hur ett Java Script reagerar på en enskild sida (SPA) kan logga in användare av personliga konton, arbets konton och skol konton med hjälp av flödet för auktoriseringskod och anropa Microsoft Graph.
...
> [!IMPORTANT]
> MSAL-reagera [!INCLUDE [PREVIEW BOILERPLATE](../../../includes/active-directory-develop-preview.md)]
...
> [!div renderon="docs"]
> Om du vill köra projektet med en webb server med hjälp av Node.js [laddar du ned de centrala projektfilerna](https://github.com/Azure-Samples/ms-identity-javascript-react-spa/archive/main.zip).

> [!div renderon="portal" class="sxs-lookup"]
> Kör projektet med en webb server genom att använda Node.js

> [!div renderon="portal" class="sxs-lookup" id="autoupdate" class="nextstepaction"]
> [Ladda ned kod exemplet](https://github.com/Azure-Samples/ms-identity-javascript-react-spa/archive/main.zip)

> [!div renderon="docs"]
> #### <a name="step-3-configure-your-javascript-app"></a>Steg 3: Konfigurera din JavaScript-app
>
> I mappen *src* öppnar du *authConfig.js* -filen och uppdaterar `clientID` `authority` värdena,, och `redirectUri` i `msalConfig` objektet.
>
> ```javascript
> /**
...
1. Välj **Logga** in för att starta inloggnings processen och anropa sedan Microsoft Graph-API: et.
    ...
    Första gången du loggar in uppmanas du att ange ditt medgivande så att programmet kan komma åt din profil och logga in dig. När du har loggat in klickar du på **begär profil information** för att visa din profil information på sidan.

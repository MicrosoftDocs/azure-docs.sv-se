---
title: 'Självstudie: Konfigurera Fortes ändra moln för automatisk användar etablering med Azure Active Directory | Microsoft Docs'
description: Lär dig att automatiskt etablera och avetablera användar konton från Azure AD till Fortes ändra molnet.
...
I den här självstudien beskrivs de steg du behöver utföra i både Fortes ändra molnet och Azure Active Directory (Azure AD) för att konfigurera automatisk användar etablering. När Azure AD har kon figurer ATS etablerar och avetablerar Azure AD automatiskt användare och grupper för att [Fortes ändra molnet](https://fortesglobal.com/) med Azure AD Provisioning-tjänsten. Viktig information om vad den här tjänsten gör, hur den fungerar och vanliga frågor finns i [Automatisera användaretablering och avetablering för SaaS-program med Azure Active Directory](../manage-apps/user-provisioning.md). 


## <a name="capabilities-supported"></a>Funktioner som stöds
> [!div class="checklist"]
> * Skapa användare i Fortes Change Cloud
> * Ta bort användare i Fortes ändra moln när de inte behöver åtkomst längre
...
* En Fortes ändra moln klient organisation.
* Ett användar konto i Fortes ändra moln med administratörs behörighet.
...
3. Bestäm vilka data som ska [mappas mellan Azure AD-och Fortes-ändrings molnet](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
## <a name="step-3-add-fortes-change-cloud-from-the-azure-ad-application-gallery"></a>Steg 3. Lägg till Fortes Change Cloud från Azure AD Application Gallery

Lägg till Fortes ändra moln från Azure AD-programgalleriet för att börja hantera etablering till Fortes Change Cloud. Om du tidigare har konfigurerat Fortes ändra molnet för enkel inloggning kan du använda samma program. Vi rekommenderar dock att du skapar en separat app när du testar integreringen i början. Lär dig mer om att lägga till ett program från galleriet [här](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
## <a name="step-5-configure-automatic-user-provisioning-to-fortes-change-cloud"></a>Steg 5. Konfigurera automatisk användar etablering till Fortes ändra moln 

Det här avsnittet vägleder dig genom stegen för att konfigurera Azure AD Provisioning-tjänsten för att skapa, uppdatera och inaktivera användare och/eller grupper i TestApp baserat på användar-och/eller grupp tilldelningar i Azure AD.

### <a name="to-configure-automatic-user-provisioning-for-fortes-change-cloud-in-azure-ad"></a>Konfigurera automatisk användar etablering för Fortes ändra moln i Azure AD:

1. Logga in på [Azure-portalen](https://portal.azure.com). Välj **Företagsprogram** och sedan **Alla program**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan program väljer du **Fortes ändra moln**.

    ![Fortes ändra moln länk i program listan](common/all-applications.png)
...
5. Under avsnittet **admin credentials** , ange din Fortes ändra Cloud Tenant URL och hemlig token. Klicka på **Testa anslutning** för att se till att Azure AD kan ansluta till Fortes Change Cloud. Om anslutningen Miss lyckas ser du till att Fortes ändra moln kontot har administratörs behörighet och försöker igen.
...
8. Under avsnittet **mappningar** väljer du **Synkronisera Azure Active Directory användare till Fortes ändra moln**.

9. Granska de användarattribut som synkroniseras från Azure AD till Fortes ändra moln i avsnittet **attribut-mappning** . Attributen som väljs som **matchande** egenskaper används för att matcha användar kontona i Fortes ändra moln för uppdaterings åtgärder. Om du väljer att ändra [matchande målattribut](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)måste du se till att Fortes ändra Cloud API stöder filtrering av användare baserat på det attributet. Välj knappen **Spara** för att spara ändringarna.
   ...
   |externalId|Sträng|
   |urn: IETF: params: scim: schemas: tillägg: FCC: 2.0: användare: administratör|Boolesk|
   |urn: IETF: params: scim: schemas: tillägg: FCC: 2.0: användare: loginDisabled|Boolesk|
...
11. Om du vill aktivera Azure AD Provisioning-tjänsten för Fortes ändra molnet ändrar du **etablerings statusen** till **på** i avsnittet **Inställningar** .

    ![Etableringsstatus är på](common/provisioning-toggle-on.png)

12. Definiera de användare och/eller grupper som du vill etablera för att Fortes ändra moln genom att välja önskade värden i **omfång** i avsnittet **Inställningar** .

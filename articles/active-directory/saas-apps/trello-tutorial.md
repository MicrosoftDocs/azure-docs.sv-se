...
## <a name="configure-and-test-azure-ad-sso-for-trello"></a>Konfigurera och testa Azure AD SSO för Trello
...
Utför följande steg för att konfigurera och testa Azure AD SSO med Trello:
...
1. I Azure Portal går du till sidan för program integrering i **Trello** , letar upp avsnittet **Hantera** och väljer **enkel inloggning**.
...
1. I avsnittet **grundläggande SAML-konfiguration** , om du vill konfigurera programmet i **IDP** initierat läge, anger du värdena för följande fält:
    ...
    a. Skriv webb adressen i text rutan **identifierare** : `https://trello.com/auth/saml/metadata`
...
* Klicka på **testa det här programmet** i Azure Portal. Detta omdirigeras till Trello-inloggnings-URL där du kan starta inloggnings flödet.  

* Gå till Trello-inloggnings-URL: en direkt och starta inloggnings flödet därifrån.

#### <a name="idp-initiated"></a>IDP initierad:

* Klicka på **testa det här programmet** i Azure Portal så bör du loggas in automatiskt på den Trello som du ställer in SSO för. 

Du kan också använda Microsoft Mina appar för att testa programmet i vilket läge som helst. När du klickar på panelen Trello i Mina appar, om det kon figurer ATS i SP-läge, omdirigeras du till programmets inloggnings sida för att initiera inloggnings flödet och om det har kon figurer ATS i IDP-läge, bör du loggas in automatiskt på Trello som du ställer in SSO för. Mer information om Mina appar finns i [Introduktion till Mina appar](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Nästa steg

När du har konfigurerat Trello kan du genomdriva session Control, som skyddar exfiltrering och intrånget för organisationens känsliga data i real tid. Kontroll av sessionen sträcker sig från villkorlig åtkomst. [Lär dig hur du tvingar fram en session med Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
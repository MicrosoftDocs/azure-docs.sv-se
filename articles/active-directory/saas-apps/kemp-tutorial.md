...
## <a name="add-kemp-loadmaster-azure-ad-integration-from-the-gallery"></a>Lägg till Kemp: LoadMaster Azure AD integration från galleriet
...
Utför följande steg för att konfigurera och testa Azure AD SSO med Kemp: LoadMaster Azure AD-integrering:
...
1. I Azure Portal på sidan **Kemp: LoadMaster Azure AD integration** Application Integration hittar du avsnittet **Hantera** och väljer **enkel inloggning**.

...
3. Ta reda på vilka data som ska [mappas mellan Azure AD och Monday.com](../app-provisioning/customize-application-attributes.md). 
...
* När du tilldelar användare och grupper till monday.com måste du välja en annan roll än **standard åtkomst**. Användare med rollen Standardåtkomst undantas från etableringen och markeras som icke-berättigade i etableringsloggarna. Om den enda rollen som är tillgänglig i programmet är standardrollen för åtkomst, kan du [uppdatera applikationsmanifest](../develop/howto-add-app-roles-in-azure-ad-apps.md) och lägga till fler roller. 
...
9. Granska de användarattribut som synkroniseras från Azure AD till monday.com i avsnittet **attribut-mappning** . Attributen som väljs som **matchande** egenskaper används för att matcha användar kontona i Monday.com för uppdaterings åtgärder. Om du väljer att ändra [matchande målattribut](../app-provisioning/customize-application-attributes.md)måste du se till att Monday.com-API: et stöder filtrering av användare baserat på det attributet. Välj knappen **Spara** för att spara ändringarna.
...
* monday.com stöder endast userType "admin", "gäst", "medlem" och "Viewer". UserType "User" stöds inte och kommer att tas bort i framtiden.

## <a name="change-log"></a>Ändringslogg
* 1/21/2021 – stöd för Core-attributet "userType" för användare har lagts till.

...
3. Ta reda på vilka data som ska [mappas mellan Azure AD och SecureLogin](../app-provisioning/customize-application-attributes.md). 
...
9. Granska de användarattribut som synkroniseras från Azure AD till SecureLogin i avsnittet **attribut-mappning** . Attributen som väljs som **matchande** egenskaper används för att matcha användar kontona i SecureLogin för uppdaterings åtgärder. Om du väljer att ändra [matchande målattribut](../app-provisioning/customize-application-attributes.md)måste du se till att SecureLogin-API: et stöder filtrering av användare baserat på det attributet. Välj knappen **Spara** för att spara ändringarna.

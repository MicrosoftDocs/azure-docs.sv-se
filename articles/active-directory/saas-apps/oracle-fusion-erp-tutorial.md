...
* Du kan använda Microsoft Mina appar. När du klickar på panelen för Oracle Fusion ERP i Mina appar omdirigeras den till URL: en för Oracle Fusion ERP-inloggning. Mer information om Mina appar finns i [Introduktion till Mina appar](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

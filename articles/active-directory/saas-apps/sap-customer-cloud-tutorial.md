...
## <a name="configure-and-test-azure-ad-sso-for-sap-cloud-for-customer"></a>Konfigurera och testa Azure AD SSO för SAP-molnet för kunden
...
1. I Azure Portal går du till sidan **SAP-moln för** integrering av kund program och letar upp avsnittet **Hantera** och väljer **enkel inloggning**.
...
* Klicka på **testa det här programmet** i Azure Portal. Detta omdirigerar till SAP Cloud för kund inloggnings-URL där du kan starta inloggnings flödet. 

* Gå till SAP Cloud för kund inloggnings-URL: en direkt och starta inloggnings flödet därifrån.

* Du kan använda Microsoft Mina appar. När du klickar på panelen SAP-moln för kund i Mina appar omdirigeras det till SAP Cloud för kund inloggnings-URL. Mer information om Mina appar finns i [Introduktion till Mina appar](../user-help/my-apps-portal-end-user-access.md).


## <a name="next-steps"></a>Nästa steg

När du har konfigurerat SAP-molnet för kunden kan du genomdriva sessionsnycklar som skyddar exfiltrering och intrånget för organisationens känsliga data i real tid. Sessions kontroller utökas från villkorlig åtkomst. [Lär dig hur du tvingar fram en session med Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad).
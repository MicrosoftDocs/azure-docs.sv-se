...
* Du kan använda Microsoft Mina appar. När du klickar på arbets ytans ikon i Mina appar, bör du loggas in automatiskt på den arbets yta som du har konfigurerat SSO för. Mer information om Mina appar finns i [Introduktion till Mina appar](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
## <a name="add-blackboard-learn-from-the-gallery"></a>Lägg till svart tavla lär dig från galleriet
...
## <a name="configure-and-test-azure-ad-sso-for-blackboard-learn"></a>Konfigurera och testa Azure AD SSO för svart, lär dig mer
...
Utför följande steg för att konfigurera och testa Azure AD SSO med svart tavla-information:
...
1. I Azure Portal på **svart tavla** -sidan Läs program integration letar du upp avsnittet **Hantera** och väljer **enkel inloggning**.
...
I det här avsnittet skapas en användare som kallas B. Simon i svart tavla-information. Svart tavla har stöd för just-in-Time-etablering av användare, som är aktiverat som standard. Det finns inget åtgärds objekt i det här avsnittet. Om en användare inte redan finns i svart tavla får du en ny som skapas efter autentiseringen.

## <a name="test-sso"></a>Testa SSO

I det här avsnittet ska du testa Azure AD-konfigurationen för enkel inloggning med följande alternativ. 

* Klicka på **testa det här programmet** i Azure Portal. Detta omdirigeras till svart tavla lär dig inloggnings-URL där du kan starta inloggnings flödet. 

* Gå till svart tavla lär dig inloggnings-URL direkt och starta inloggnings flödet därifrån.

* Du kan använda Microsoft Mina appar. När du klickar på ikonen för svart tavla i Mina appar omdirigeras den till svart tavla-URL för information. Mer information om Mina appar finns i [Introduktion till Mina appar](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Nästa steg

När du har konfigurerat svart tavla lär du dig att använda session Control, som skyddar exfiltrering och intrånget för organisationens känsliga data i real tid. Kontroll av sessionen sträcker sig från villkorlig åtkomst. [Lär dig hur du tvingar fram en session med Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
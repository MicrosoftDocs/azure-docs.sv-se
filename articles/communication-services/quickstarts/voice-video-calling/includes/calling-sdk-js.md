...
Om du vill ringa till en annan kommunikations tjänst användare, anropar du `startCall` metoden på `callAgent` och skickar den CommunicationUserIdentifier som du har [skapat med identitets biblioteket för kommunikations tjänster](https://docs.microsoft.com/azure/communication-services/quickstarts/access-tokens).

...
Det inkommande anropet kan erhållas genom att prenumerera på `CallsUpdated` händelsen på `callAgent` objektet och loopa genom de tillagda anropen:

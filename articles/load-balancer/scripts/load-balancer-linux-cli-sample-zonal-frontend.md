---
title: Belastningsutjämna virtuella datorer i en zon – Azure CLI
...
ms.locfileid: "107788735"
---
# <a name="azure-cli-script-example-load-balance-traffic-to-vms-within-a-specific-availability-zone"></a>Exempel på Azure CLI-skript: Belastningsutjämna trafik till virtuella datorer inom en specifik tillgänglighetszon

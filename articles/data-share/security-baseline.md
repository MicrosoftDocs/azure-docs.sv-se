...
**Vägledning**: Azure Data Share stöder SSO-autentisering med Azure Active Directory (Azure AD). Minska antalet identiteter och autentiseringsuppgifter som användarna måste hantera genom att aktivera SSO för tjänsten med din organisations befintliga identiteter.
...
**Vägledning**: Aktivera Azure AD multifaktor-autentisering och följ Azure Security Center identitets-och åtkomst rekommendationer.
...
- [Så här aktiverar du Azure AD multifaktor-autentisering](../active-directory/authentication/howto-mfa-getstarted.md)

...
Eller, om du vill installera en speciell version av säkerhets-daemonen, anger du versionen från apt lista utdata. Ange också samma version för **libiothsm-STD-** paketet, vilket annars skulle installera den senaste versionen. Följande kommando installerar till exempel den senaste versionen av 1,1-versionen:
...
Eller, om du vill installera en speciell version av IoT Edge och identitets tjänsten, anger du versionerna från apt lista utdata. Ange samma versioner för båda tjänsterna. Följande kommando installerar till exempel den senaste versionen av 1,2-versionen:

...
| --- | --- | --- | --- |
| Maximalt antal Basic-eller standard-namnområden per Azure-prenumeration |Namnområde |Efterföljande förfrågningar om fler Basic-eller standard-namnområden avvisas av Azure Portal. | Standardvärdet är 100. <br/> Det maximala värdet är 1 000. <br/><br/> För att öka gränsen för kontakta Azure-supporten. |
| Maximalt antal Premium-namnområden per Azure-prenumeration |Namnområde |Efterföljande begär Anden om ytterligare Premium-namnområden avvisas av portalen. | Standardvärdet är 100. <br/> Det maximala värdet är 1 000. <br/><br/> För att öka gränsen för kontakta Azure-supporten. |

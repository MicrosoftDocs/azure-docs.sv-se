...
ms.locfileid: "106491198"
---
## <a name="prerequisites"></a>Förutsättningar

För att slutföra stegen i den här artikeln behöver du ett Azure IoT Central-program som skapats med hjälp av den **anpassade program** mal len. Mer information finns i [snabbstarten om att skapa ett program](../articles/iot-central/core/quick-deploy-iot-central.md). Programmet måste ha skapats den 14 juli 2020 eller senare.
...
I kopian av Microsoft Azure IoT SDK för C som du har hämtat tidigare öppnar du *Azure-IoT-SDK-c/iothub_client/samples/pnp/pnp_temperature_controller/pnp_temperature_controller. c* och *Azure-IoT-SDK-c/iothub_client/samples/pnp/pnp_temperature_controller/pnp_thermostat_component. c-* filer i en text redigerare.
...
I *pnp_temperature_controller. c* `main` anropar funktionen först `CreateDeviceClientAndAllocateComponents` :
...
* Skapar en hanterare för kommandon i temperatur styrenhets komponenten.
* Skapar en hanterare för egenskaps uppdateringar i temperatur styrenhets komponenten.
* Skapar de två termostat-komponenterna.

`main`Funktionen Next:

* Rapporterar några inledande egenskaps värden för alla komponenter.
* Startar en slinga för att skicka telemetri från alla komponenter.
...
I `pnp_thermostat_component.c` `PnP_ThermostatComponent_SendTelemetry` visar funktionen hur enheten skickar en temperatur telemetri från en komponent till IoT Central:
...
I `pnp_thermostat_component.c` `PnP_TempControlComponent_Report_MaxTempSinceLastReboot_Property` skickar funktionen en `maxTempSinceLastReboot` egenskaps uppdatering från komponenten till IoT Central:
...
I `pnp_thermostat_component.c` `PnP_ThermostatComponent_ProcessPropertyUpdate` hanterar funktionen skrivbara egenskaps uppdateringar från IoT Central:
...
I `pnp_thermostat_component.c` `PnP_ThermostatComponent_ProcessCommand` hanterar funktionen kommandon som anropas från IoT Central:

...
1. För **program** väljer du ett webb program som du [har registrerat tidigare](../articles/active-directory-b2c/troubleshoot-custom-policies.md#troubleshoot-the-runtime). **Svars-URL: en** ska visas `https://jwt.ms` .

...
| [Placerings grupper för närhet](https://docs.microsoft.com/azure/virtual-machines/windows/proximity-placement-groups-portal) per [resurs grupp](../articles/azure-resource-manager/management/overview.md#resource-groups) | 800 | 
...
<sup>2</sup> egenskaper som t. ex. offentliga SSH-nycklar skickas också som certifikat och räknas mot den här gränsen. Använd [Azure Key Vault tillägget för Windows](https://docs.microsoft.com/azure/virtual-machines/extensions/key-vault-windows) eller [Azure Key Vault tillägget för Linux](https://docs.microsoft.com/azure/virtual-machines/extensions/key-vault-linux) för att installera certifikat för att kringgå den här gränsen.

...
ms.locfileid: "98798671"
---
Navigera till det lagrings konto som du vill begränsa all åtkomst till den offentliga slut punkten. Välj **nätverk** i innehålls förteckningen för lagrings kontot.
...
[![Skärm bild av bladet nätverk med lämplig begränsning på plats](media/storage-files-networking-endpoints-public-disable-portal/disable-public-endpoint-0.png)](media/storage-files-networking-endpoints-public-disable-portal/disable-public-endpoint-0.png#lightbox)
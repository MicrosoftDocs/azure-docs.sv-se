...
2. Välj **Återställ enhet**.
    ...
    ![Återställ enhet](media/azure-stack-edge-device-reset/device-reset-1.png)

3. När du uppmanas att bekräfta kontrollerar du varningen och väljer **Ja** för att fortsätta.

    ![Bekräfta återställning](media/azure-stack-edge-device-reset/device-reset-2.png)  

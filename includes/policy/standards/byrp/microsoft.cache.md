...
|Kontroll av nätverksanslutning |0812.01n2Organizational.8 – 01.n |Fjärranslutna enheter som upprättar en icke-fjärranslutning tillåts inte att kommunicera med externa (fjärranslutna) resurser. |[Endast säkra anslutningar till Azure Cache for Redis bör vara aktiverade](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F22bee202-a82f-4305-9a2a-6d7f44d4dedb) |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Cache/RedisCache_AuditSSLPort_Audit.json) |
